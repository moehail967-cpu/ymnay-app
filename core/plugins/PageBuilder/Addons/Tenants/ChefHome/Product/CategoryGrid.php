...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Browse by Cuisine')),
        ...
        return self::renderView('tenant.chefhome.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('ChefHome: Category Grid');
    }
