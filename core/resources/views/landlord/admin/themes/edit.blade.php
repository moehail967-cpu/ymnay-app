                ...
                <form class="forms-sample" method="post" action="{{route(route_prefix().'admin.theme.update')}}">
                    ...
                    <div class="row">
                                ...
                                <div class="d-flex align-items-start mb-8 metainfo-inner-wrap">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane fade show active" id="v-general-meta-info" role="tabpanel" >
                                            ...
                                            <x-fields.tw-media-upload name="meta_image" dimentions="1200x1200" :id="optional($theme->metainfo)->image"/>
                                        </div>
                                        <div class="tab-pane fade" id="v-facebook-meta-info" role="tabpanel" >
                                            ...
                                            <x-fields.tw-media-upload name="fb_image" dimentions="1200x1200" :id="optional($theme->metainfo)->fb_image"/>
                                        </div>
                                        <div class="tab-pane fade" id="v-twitter-meta-info" role="tabpanel" >
                                            ...
                                            <x-fields.tw-media-upload name="tw_image" dimentions="1200x1200" :id="optional($theme->metainfo)->tw_image"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-3">
                            ...
                            <x-fields.tw-media-upload name="image" :id="$theme->image" dimentions="{{__('4 : 5 ratio image recommended')}}"/>
