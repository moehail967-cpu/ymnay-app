...
namespace Plugins\PageBuilder\Addons\Tenants\Freshmart\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Fresh Picks Today')),
            'products'       => $products,
        ...
        return self::renderView('tenant.freshmart.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Freshmart: Featured Products');
    }
