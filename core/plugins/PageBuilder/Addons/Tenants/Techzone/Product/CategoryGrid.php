...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Browse Categories')),
        ...
        return self::renderView('tenant.techzone.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('Techzone: Category Grid');
    }
