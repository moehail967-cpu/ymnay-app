...
namespace Plugins\PageBuilder\Addons\Tenants\Fitpeak\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.fitpeak.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Fitpeak: Hero Section');
    }
