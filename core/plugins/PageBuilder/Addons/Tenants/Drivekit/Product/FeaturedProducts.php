...
namespace Plugins\PageBuilder\Addons\Tenants\Drivekit\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Top Parts')),
            'products'       => $products,
        ...
        return self::renderView('tenant.drivekit.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Drivekit: Featured Products');
    }
