...
<div class="el-page-banner">
    <div class="container">
        <h1 class="el-page-banner-title">{!! $page_post->title !!}</h1>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="el-sidebar-card">
                <span class="el-sidebar-title">{{ __('Search') }}</span>
                <div class="el-search-bar">
                    <input type="text" id="el-search-input" placeholder="{{ __('Search products…') }}">
            ...
            <div class="el-sidebar-card">
                ...
                <div class="el-size-list">
                    ...
                    <div class="el-size-item">
                        <input type="checkbox" class="el-size-checkbox" id="size_{{ $size->id }}" data-slug="{{ $size->id }}" data-label="{{ $size->size_code }}">
            ...
            <div class="el-sidebar-card">
                ...
                <div class="el-color-list">
                    ...
                    <div class="el-color-item" title="{{ $color->name }}">
                        <input type="checkbox" class="el-color-checkbox" id="color_{{ $color->id }}" data-slug="{{ $color->id }}">
...
$(function () {
    ...
    function elFilterRequest(page) {
        ...
        $.ajax({
            ...
            data: {
                ...
                page:      page,
                search:    $('#el-search-input').val() || null,
                tag:       tag
            },
    ...
    $(document).on('keydown', '#el-search-input', function (e) { if (e.key === 'Enter') elFilterRequest(); });

    $(document).on('click', '#el-clear-filters', function () {
        $('.el-cat-checkbox, .el-size-checkbox, .el-color-checkbox').prop('checked', false);
