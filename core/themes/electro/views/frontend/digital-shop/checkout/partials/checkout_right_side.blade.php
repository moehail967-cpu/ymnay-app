<div class="el-checkout-summary mt-4">
    <h2 class="el-cart-summary-title"> {{__('Order Summary')}} </h2>
    <form action="#" class="el-coupon-row coupon-contents-form mt-4">
        ...
        <input class="el-form-input coupon-code" type="text" placeholder="{{__('Coupon Code')}}"
               name="used_coupon">
        <button type="button" class="el-btn el-btn-outline coupon-btn"> {{__('Apply Coupon')}}</button>
    </form>
    ...
    <div class="el-checkout-items coupon-border mt-4 mb-4">
        @foreach($cart_data as $data)
            <div class="el-checkout-item">
                ...
                <span class="el-checkout-item-price"> {{amount_with_currency_symbol($data->price * $data->qty)}} </span>
            </div>
        @endforeach
    </div>
            ...
            @if($user != null)
                <div class="el-summary-row d-block">
                    ...
                    @foreach($shipping_methods ?? [] as $key => $method)
                        ...
                        <div class="el-summary-row" data-country="{{isset($country) ?? 0}}"
    ...
    <div class="el-payment-section mt-4">
        <h6 class="el-payment-label"> {{__('Select Payment Method')}} </h6>
        <div class="el-payment-card payment-card mt-3">
