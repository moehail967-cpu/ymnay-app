...
{
    protected function getWidgetType(): string { return 'hexfashion_category_grid'; }
    protected function getWidgetName(): string { return 'HexFashion: Category Grid'; }
    protected function getWidgetIcon(): string|array { return 'las la-th'; }
    protected function getWidgetDescription(): string { return __('3-column fashion category showcase cards'); }
    protected function getCategory(): string { return WidgetCategory::THEME; }
    protected function getWidgetTags(): array { return ['category', 'grid', 'hexfashion']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">HexFashion: Category Grid — preview on the live page</p></div>';
        }
        ...
        return view('theme-hexfashion::widgets.category_grid', [
