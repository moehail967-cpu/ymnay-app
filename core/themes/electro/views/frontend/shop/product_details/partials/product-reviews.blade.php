<div id="reviews" class="el-pd-tab-content">
    <div class="el-pd-tab-inner">
        @if(Auth::guard('web')->check())
            <div class="el-pd-reviews">
                {{-- Leave a Review Form --}}
                <div class="el-pd-review-form">
                    ...
                    @foreach($product->reviews->take(5) ?? [] as $review)
                        <div class="el-pd-review-item">
                            ...
                            <div class="el-pd-reviewer-content">
                                ...
                                <span class="el-pd-review-date">{{ $review->created_at?->diffForHumans() }}</span>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="text-center mt-4">
                    <a href="javascript:void(0)" class="el-btn el-btn-outline see-more-review" data-items="5">
                        {{ __('See More') }}
                    </a>
                </div>
            </div>
        @else
            <div class="el-pd-review-login">
                <div class="el-auth-card" style="max-width:480px;margin:0 auto;">
