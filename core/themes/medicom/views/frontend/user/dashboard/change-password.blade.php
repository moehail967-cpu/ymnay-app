    ...
    <form action="{{ theme_user_password_change_url() }}" method="post">
        ...
        <div class="row g-3" style="max-width:500px;">
            <div class="col-12">
                ...
                <input type="password" name="current_password" class="mc-form-input" placeholder="{{ __('Enter current password') }}">
            </div>
            <div class="col-12">
                <label class="mc-form-label">{{ __('New Password') }} <span class="mc-form-required">*</span></label>
                <input type="password" name="new_password" class="mc-form-input" placeholder="{{ __('Enter new password') }}">
            </div>
            <div class="col-12">
                <label class="mc-form-label">{{ __('Confirm Password') }} <span class="mc-form-required">*</span></label>
                <input type="password" name="new_password_confirmation" class="mc-form-input" placeholder="{{ __('Confirm new password') }}">
            </div>
            <div class="col-12">
                <button type="submit" id="change_pwd_btn" class="mc-btn mc-btn-primary">
