...
{
    protected function getWidgetType(): string { return 'trailco_featured_products'; }
    protected function getWidgetName(): string { return 'TrailCo: Featured Products'; }
    protected function getWidgetIcon(): string|array { return 'mdi mdi-hiking'; }
    protected function getWidgetDescription(): string { return __('Outdoor product grid in TrailCo card style with olive/terra accents'); }
    protected function getCategory(): string { return WidgetCategory::ECOMMERCE; }
    protected function getWidgetTags(): array { return ['products', 'featured', 'trailco']; }
    ...
    public function getGeneralFields(): array
    {
        ...
        $control->addGroup('content', 'Content')
            ->registerField('title', FieldManager::TEXT()->setLabel('Section Title')->setDefault('Featured Gear'))
    ...
    public function render(array $settings = []): string
    {
        ...
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;">
                        <p style="margin:0;font-size:14px;">TrailCo: Featured Products — preview on the live page</p>
                    </div>';
        }
        ...
        return view('theme-trailco::widgets.featured_products', [
            'title'          => $content['title']        ?? 'Featured Gear',
