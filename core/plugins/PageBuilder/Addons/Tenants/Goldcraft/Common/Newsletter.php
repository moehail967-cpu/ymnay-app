...
namespace Plugins\PageBuilder\Addons\Tenants\Goldcraft\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.goldcraft.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Goldcraft: Newsletter');
    }
