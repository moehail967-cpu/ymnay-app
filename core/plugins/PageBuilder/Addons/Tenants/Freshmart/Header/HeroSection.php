...
namespace Plugins\PageBuilder\Addons\Tenants\Freshmart\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.freshmart.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Freshmart: Hero Section');
    }
