<template>
    ...
    <div v-show="showHideAddNewCustomer()" id="addCustomerButton" class="dashboard_posSystem__sidebar__item">
        <a href="#1" class="addCustomer"
           @click.prevent="document.querySelector('.add-customer-popup')?.classList.add('popup-active'); document.querySelector('.add-customer-popup-overlay')?.classList.add('popup-active')">
