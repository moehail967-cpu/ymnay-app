...
{
    protected function getWidgetType(): string        { return 'tenant_product_grid'; }
    protected function getWidgetName(): string        { return 'Product Grid'; }
    protected function getWidgetIcon(): string|array  { return 'las la-th'; }
    protected function getWidgetDescription(): string { return 'Product grid with configurable columns.'; }
    protected function getCategory(): string          { return WidgetCategory::ECOMMERCE; }
    protected function getWidgetTags(): array         { return ['products', 'grid', 'shop']; }
    ...
    public function getGeneralFields(): array
    {
        ...
        $cm->addGroup('content', 'Content')
            ->registerField('section_title', FieldManager::TEXT()
                ->setLabel('Section Title')->setDefault('Our Products'))
            ->endGroup();
    ...
    public function render(array $settings = []): string
    {
        ...
        return view('widgetbuilder::tenant.product_grid', [
            'section_title'  => $content['section_title'] ?? 'Our Products',
            'products'       => $products,
            'columns'        => $cols,
