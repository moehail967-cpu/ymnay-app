...
namespace Plugins\PageBuilder\Addons\Tenants\Trailco\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Trail Essentials')),
            'products'       => $products,
        ...
        return self::renderView('tenant.trailco.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Trailco: Featured Products');
    }
