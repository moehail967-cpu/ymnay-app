...
<div style="margin-top:20px;padding-top:20px;border-top:1px dashed var(--tr-border);">
    <a href="javascript:void(0)" class="create-accounts shift-another-address"
       style="font-size:13px;color:var(--tr-olive);font-weight:700;text-decoration:none;display:inline-flex;align-items:center;gap:6px;">
    ...
    <div class="checkout-address-form-wrapper" style="display:none;margin-top:20px;">
        <div style="background:var(--tr-cream);border:1px solid var(--tr-border);border-radius:var(--tr-radius);padding:20px;">
            <div style="font-size:13px;font-weight:700;color:var(--tr-bark);margin-bottom:16px;display:flex;align-items:center;gap:8px;">
                <i class="mdi mdi-home-outline" style="color:var(--tr-olive);"></i> {{ __('Alternate Shipping Address') }}
            </div>
            <div class="row g-3">
                <div class="col-md-6">
