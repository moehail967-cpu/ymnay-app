            ...
            <div class="col-lg-8">
                       ...
                       <div class="tab-content" >
                           ...
                           <div class="tab-pane fade @if(auth()->guard('web')->check()) show active @endif" id="nav-profile" role="tabpanel">
                            <form action="{{ route('tenant.frontend.order.payment.form') }}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group"> <input type="text" id="order_name" name="name" @if(auth()->guard('web')->check()) value="{{ auth()->guard('web')->user()->name }}" @endif class="form-control" placeholder="{{ __('Name') }}" required></div>
                                        <div class="form-group"> <input type="email" id="order_email" name="email" @if(auth()->guard('web')->check())  value="{{ auth()->guard('web')->user()->email }}" @endif class="form-control" placeholder="{{ __('Your Email') }}" required></div>
                                        ...
                                        <div class="form-group d-none manual_transaction_id">
                                            <input type="text" name="trasaction_id" class="form-control manual_transaction_id" placeholder="{{ __('Transaction ID') }}" >
                                        </div>
                ...
                <div class="order-tab-wrap">
                    ...
                    <form action="{{ route('tenant.frontend.order.payment.form') }}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                            <div class="form-group"> <input type="text" id="name" name="name" value="{{ auth()->guard('web')->user()->name }}"  class="form-control" placeholder="{{ __('Name') }}" readonly></div>
                            <div class="form-group"> <input type="email" id="email" name="email"  value="{{ auth()->guard('web')->user()->email }}" class="form-control" placeholder="{{ __('Your Email') }}" readonly></div>

                              {!! \App\Helpers\FormBuilderCustom::render_form(get_static_option('order_form'),null,null,'btn-default') !!}
                                {!! render_payment_gateway_for_form() !!}

                                <div class="form-group d-none manual_transaction_id">
                                    <input type="text" name="trasaction_id" class="form-control " placeholder="{{ __('Transaction ID') }}" >
                                </div>
                            </div>
                            <div class="col-lg-12">
                            <div class="form-group btn-wrapper">
