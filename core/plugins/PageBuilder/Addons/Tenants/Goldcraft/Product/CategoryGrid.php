...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Shop by Collection')),
        ...
        return self::renderView('tenant.goldcraft.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('Goldcraft: Category Grid');
    }
