...
@section('scripts')
    <script>
        (function ($) {
            ...
            $(document).on('click', '.hf-cart-action .close-table-cart', function (e){
                ...
                $.ajax({
                    ...
                    success: function (data){
                        if (data.msg) {
                            ...
                            $('.hf-cart-table').closest('.hf-cart-table-wrap').load(location.href + ' .hf-cart-table');
                        }
                        $('.loader').hide();
                    },
                    error: function (){}
            ...
            $(document).on('click', '.hf-cart-action .close-table-wishlist', function (e){
                let el = $(this).closest('[data-product_hash_id]');
                let product_hash_id = el.data('product_hash_id');
                $.ajax({
            ...
            $(document).on('click', '.hf-cart-action .move-to-wishlist', function (e){
                let el = $(this).closest('[data-product_hash_id]');
                let product_hash_id = el.data('product_hash_id');
                $.ajax({
