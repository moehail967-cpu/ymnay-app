...
<div class="container" style="padding:40px 0 80px;">
    <div class="row g-4">
        ...
        {{-- Sidebar --}}
        <div class="col-lg-3">
            <div class="el-dash-sidebar">
                <div class="el-dash-user-info">
                    <div class="el-dash-avatar">{{ strtoupper(substr(auth('web')->user()?->name ?? 'U', 0, 1)) }}</div>
                    <div class="el-dash-name">{{ auth('web')->user()?->name }}</div>
                    <div class="el-dash-email">{{ auth('web')->user()?->email }}</div>
                </div>
                <ul class="el-dash-nav">
