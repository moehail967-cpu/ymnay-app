    ...
    <div class="bp-order-summary">
        ...
        <div style="margin-bottom:16px;">
            ...
            <div class="bp-mini-cart-row">
                ...
                <div class="bp-checkout-mini-item-meta flex-grow-1">
                    ...
                    <div class="bp-checkout-mini-variant">
                        @foreach($data->options->attributes as $k => $v)
                            {{ $k }}: {{ $v }}{{ !$loop->last ? ',' : '' }}
                        @endforeach
                    </div>
                    @endif
        ...
        <div class="shipping_method_wrapper">
            ...
            @foreach($shipping_methods ?? [] as $key => $method)
                ...
                <div class="bp-summary-row bp-radio-row" data-country="{{ isset($country) ? $country : 0 }}" data-state="{{ isset($state) ? $state : 0 }}" data-city="{{ isset($city) ? $city : 0 }}">
