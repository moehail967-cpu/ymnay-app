...
namespace Plugins\PageBuilder\Addons\Tenants\Velvetlux\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('New Arrivals')),
            'products'       => $products,
        ...
        return self::renderView('tenant.velvetlux.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Velvetlux: Featured Products');
    }
