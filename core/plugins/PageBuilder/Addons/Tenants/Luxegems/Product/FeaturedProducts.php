...
namespace Plugins\PageBuilder\Addons\Tenants\Luxegems\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Featured Pieces')),
            'products'       => $products,
        ...
        return self::renderView('tenant.luxegems.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Luxegems: Featured Products');
    }
