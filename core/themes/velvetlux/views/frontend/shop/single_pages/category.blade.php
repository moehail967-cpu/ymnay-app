...
<div class="vl-page-header">
    <div class="container">
        ...
        <h1 style="font-style:italic;">{!! $category->name !!}</h1>
    </div>
</div>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="vl-sidebar-card">
                ...
                <div style="display:flex;border:1.5px solid var(--vl-border,#e0e0e0);border-radius:var(--vl-radius,4px);overflow:hidden;">
                    <input type="text" id="vl-search-input" placeholder="{{ __('Search products…') }}"
                        style="flex:1;border:none;outline:none;padding:9px 12px;font-size:13px;background:transparent;">
                    <button type="button" onclick="velvetluxFilterRequest()"
                        style="background:var(--vl-gold,#C9A84C);color:#fff;border:none;padding:0 14px;cursor:pointer;">
            ...
            <div class="vl-sidebar-card">
                ...
                <div style="margin-top:10px;">
                    <a href="javascript:void(0)" onclick="$('.vl-rating-filter,.vl-cat-checkbox').prop('checked',false);velvetluxFilterRequest();"
                        style="font-size:12px;color:var(--vl-muted,#888);text-decoration:none;">
...
$(function () {
    function velvetluxFilterRequest(page) {
        ...
        var search    = $('#vl-search-input').val() || null;
    ...
    $(document).on('keydown', '#vl-search-input', function (e) {
        if (e.key === 'Enter') { velvetluxFilterRequest(); }
    });
