                ...
                <div class="lg:col-span-1 flex flex-col gap-6">
                    ...
                    <div class="bg-[#F8FAFB] border border-borderCS rounded-2xl p-8">
                        <div class="mb-6">
                            ...
                            <p class="text-quate text-sm">{{\App\Enums\PricePlanTypEnums::getText($order_details->type)}}</p>
                        </div>
                            ...
                            <div class="space-y-3">
                                @foreach($order_details->plan_features as $item)
                                    <div class="flex items-center gap-3">
                                        ...
                                        <span class="text-gray-700">{{__(str_replace('_', ' ', ucwords($item->feature_name))) ?? ''}}</span>
                                    </div>
                                @endforeach
                            </div>
                        </div>
                ...
                <div class="lg:col-span-2 flex flex-col gap-8">
                    ...
                    @if($order_details->description)
                        <div class="bg-[#F8FAFB] border border-borderCS rounded-2xl p-8">
                            ...
                            <p class="text-gray-600 leading-7 text-justify">{{$order_details->description}}</p>
                        </div>
                    @endif
                        ...
                        <div class="bg-[#F8FAFB] border border-borderCS rounded-2xl p-8">
                            ...
                            <div class="space-y-3" id="faq_{{$rand_number}}" itemscope itemtype="https://schema.org/FAQPage">
                                @foreach($faq_items['title'] as $index => $faq)
                                    <div class="faq-item {{$index === 0 ? 'active' : ''}} border border-gray-200 rounded-xl overflow-hidden"
                                         itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">

                                        <button type="button"
                                            class="faq-toggle w-full flex items-center justify-between px-6 py-4 bg-white hover:bg-gray-50 transition-colors text-left"
                                            itemprop="name">
                                            <span class="font-medium text-secondary">{{purify_html($faq)}}</span>
                                            <span class="flex-shrink-0 ml-4">
                                                <i class="icon-base ti tabler-minus faq-icon-open text-sectionC"></i>
                                                <i class="icon-base ti tabler-plus faq-icon-close text-gray-400"></i>
                                            </span>
                                        </button>

                                        <div class="faq-answer {{$index === 0 ? 'open' : ''}} px-6 pb-5 bg-white"
                                             itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
                                            <div class="border-t border-gray-100 pt-4 text-gray-600 leading-7" itemprop="text">
...
//                                dd($default_selected_theme);
                                ...
                                <div class="group bg-white rounded-xl overflow-hidden border-2 duration-300 hover:border-sectionC theme-card {{$default_selected_theme ? 'selected_theme' : ''}}"
                                    ...
                                    <div class="relative">
                                        ...
                                        <div class="absolute inset-0 flex items-center justify-center bg-black/20 opacity-0 scale-95 group-hover:opacity-100 group-hover:scale-100 transition-all duration-300 ease-out z-10">
                                            @if(!empty($theme_custom_url))
                                                <a href="{{$theme_custom_url}}" target="_blank"
                                                   class="w-40 bg-gray-100 hover:bg-primary text-secondary hover:text-white py-3 rounded-xl font-semibold shadow-xl transition-all duration-300 flex items-center justify-center gap-2 text-sm"
                                        ...
                                        {{-- Card Content --}}
                                        <div class="p-4 bg-white group-hover:opacity-0 transition-opacity duration-300 ease-out">
        ...
        <div class="modal-overlay" id="trialModal">
            <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl mx-4 overflow-hidden">
                ...
                <div class="flex items-center justify-between px-8 py-5 border-b border-gray-100">
                    ...
                    <button type="button" class="modal-close-btn w-8 h-8 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors" data-modal="trialModal">
                        <i class="icon-base ti tabler-x text-gray-500"></i>
                    </button>
                </div>
                {{-- Body --}}
                <div class="px-8 py-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
                        {{-- Personal Info --}}
                        <div>
                            <h5 class="text-base font-medium text-secondary mb-4 pb-2 border-b border-gray-100">{{__('Personal Information')}}</h5>
                            <div class="space-y-3 text-sm text-gray-700">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none text-sm"
                        ...
                        {{-- Package Info --}}
                        <div>
                            <h5 class="text-base font-medium text-secondary mb-4 pb-2 border-b border-gray-100">{{__('Package Information')}}</h5>
                            <div class="space-y-3 text-sm text-gray-700">
