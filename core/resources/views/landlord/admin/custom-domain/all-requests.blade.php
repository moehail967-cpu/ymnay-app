...
<div class="bg-surface rounded-xl shadow-main border border-main mb-6">
    ...
    <div class="px-4 sm:px-6 py-4 border-b border-main rounded-t-xl flex items-center gap-3">
        ...
        <div>
            <h3 class="text-sm font-bold text-dark font-urbanist">{{__('All Custom Domain Requests')}}</h3>
            <p class="text-xs text-muted">{{__('Manage tenant custom domain requests')}}</p>
        </div>
    </div>
    ...
    <div class="tw-table-wrap">
        <table class="w-full text-left" id="all_domain_table">
            <thead>
                ...
                <tr class="border-b border-subtle hover:bg-muted transition">
                    ...
                    <td class="px-4 py-3">
                        ...
                        @elseif($data->custom_domain_status == 'connected')
                            <span class="tw-pill tw-pill-success">{{__('Connected')}}</span>
                        @elseif($data->custom_domain_status == 'removed')
                            <span class="tw-pill tw-pill-danger">{{__('Removed')}}</span>
                        @elseif($data->custom_domain_status == 'rejected')
                            <span class="tw-pill tw-pill-gray">{{__('Rejected')}}</span>
                        @endif
                    </td>
