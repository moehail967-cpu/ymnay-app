...
<div class="container" style="padding-top:32px;">
    <h1 class="lg-page-title">{{ $page_title }}</h1>
</div>
...
<div class="container" style="{{ $wishlist ? 'padding-top:24px;' : '' }}padding-bottom:80px;">
    <div class="row g-4">
        ...
        <div class="col-lg-{{ $wishlist ? '12' : '8' }}">
            <div style="background:var(--lx-dark);border:1px solid var(--lx-border);overflow:hidden;">
                <div class="table-responsive">
                    <table class="lg-cart-table" style="width:100%;border-collapse:collapse;">
                        <thead>
                            <tr>
                                <th>{{ __('Product') }}</th>
                                <th>{{ __('Price') }}</th>
                        ...
                        @foreach($cart_data as $key => $data)
                            ...
                            <tr class="table-cart-row"
                                ...
                                <td class="lg-cart-action-cell {{ $wishlist ? 'lg-cart-action-wishlist d-flex justify-content-around align-items-center' : '' }}"
                                    data-product_hash_id="{{ $data->rowId }}">
                                    @if($wishlist)
                                        <div class="move-to-wishlist" title="{{ __('Move to Cart') }}" style="cursor:pointer;color:var(--lx-gold);">
            ...
            <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap mt-4">
                <a href="{{ theme_shop_url() }}" class="lx-btn lx-btn-outline">
                    <i class="las la-arrow-left"></i> {{ __('Continue Shopping') }}
                </a>
                @if(!$wishlist)
                <a href="javascript:void(0)" class="lx-btn lx-btn-outline clear-cart-btn"
        ...
        <div class="col-lg-4">
            <div class="lg-summary-card">
                ...
                <a href="{{ theme_checkout_url() }}"
                   class="lx-btn lx-btn-primary w-100 justify-content-center mt-4"
                   style="font-size:11px;padding:14px;">
                    {{ __('Proceed to Checkout') }} <i class="las la-arrow-right"></i>
                </a>

                <div class="lg-secure-note mt-3">
