...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        ProductInventory::observe(StockNotificationObserver::class);
        ProductModel::observe(ProductPriceObserver::class);
    }
}
