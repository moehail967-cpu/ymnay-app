...
class SidebarMenuHelper
{
    ...
    public function render_sidebar_menus(): string
    {
        ...
        $menu_instance = new \App\Helpers\TailwindMenuWithPermission();
...
//        $this->testimonial_settings_menus($menu_instance);
        ...
        // External plugin menus are now registered via MenuRegistry in each plugin's boot().
        // inject_plugin_registry_menus() (called below) renders them all.

        $menu_instance->add_menu_item('plugin-manager-menu', [
            'route'       => 'landlord.admin.plugins.index',
            'label'       => __('Plugins'),
            'parent'      => null,
            'permissions' => [],
        ...
        $this->inject_plugin_registry_menus($menu_instance, 'landlord');

        return $menu_instance->render_menu_items();
    }

    private function pages_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
// testimonial
    ...
    private function themes_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function price_plan_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function commission_manage_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//            'permissions' => ['price-plan-list'],
        ...
        $menu_instance->add_menu_item('commission-history-page', [
            'route' => 'landlord.admin.commission.history',
            'label' => __('Commission History'),
            'parent' => 'commission-manage-settings-menu-items',
//            'permissions' => ['price-plan-list'],
        ]);
        $menu_instance->add_menu_item('withdraw-gateway-page', [
            'route' => 'admin.withdraw.gateways.index',
            'label' => __('Withdraw Gateways'),
            'parent' => 'commission-manage-settings-menu-items',
//            'permissions' => ['price-plan-list'],
        ]);
        $menu_instance->add_menu_item('commission-pay-log', [
            'route' => 'admin.commission.payment-logs',
            'label' => __('Commission Pay Logs'),
            'parent' => 'commission-manage-settings-menu-items',
//            'permissions' => ['price-plan-list'],
        ]);
    }

    private function order_manage_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//        ]);
    ...
    private function custom_domain_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function support_ticket_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function blog_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function form_builder_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function appearance_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function general_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('general-settings-menu-items', [
            ...
            'permissions' => ['general-settings-page-settings', 'general-settings-site-identity', 'general-settings-basic-settings', 'general-settings-color-settings',
                ...
                'general-settings-database-upgrade-settings', 'general-settings-cache-clear-settings', 'general-settings-license-settings', 'software-update-settings', 'language-list',
        ...
        $menu_instance->add_menu_item('general-settings-licence-settings', [
            'route' => 'landlord.admin.general.licence.settings',
            'label' => __('License Settings'),
            'parent' => 'general-settings-menu-items',
            'permissions' => ['general-settings-licence-settings'],
        ]);
        $menu_instance->add_menu_item('general-settings-software-update', [
            'route' => 'admin.general.update.v2',
            'label' => __('Software Update'),
            'parent' => 'general-settings-menu-items',
            'permissions' => ['software-update-settings'],
        ]);
    ...
    private function payment_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function users_manage_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function admin_manage_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function wallet_manage_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//        dd($current_tenant_payment_data);
        ...
        $commissionSetting = \Modules\CommissionManage\Entities\CommissionSetting::first();
        ...
        $this->tenant_plugin_manager_menu($menu_instance);
        ...
        if (!$commissionSetting || !$commissionSetting->isUsingLandlordGateway()) {
            $this->tenant_payment_settings_menus($menu_instance);
        }

        $this->inject_plugin_registry_menus($menu_instance, 'tenant');

        return $menu_instance->render_menu_items();
    }
    private function tenant_order_manage_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_sales_report_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_pages_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('pages-settings-menu-items', [
            'route' => '#',
            'label' => __('Pages'),
    ...
    private function tenant_plugin_manager_menu(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('tenant-plugin-manager-menu', [
            'route'       => 'tenant.admin.plugins.index',
            'label'       => __('Plugins'),
            'parent'      => null,
            'permissions' => [],
            'icon'        => 'mdi mdi-puzzle-outline',
    ...
    private function tenant_product_manage_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//        ]);
    ...
    private function tenant_blog_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('blog-settings-menu-items', [
            'route' => '#',
            'label' => __('Blogs'),
    ...
    private function tenant_country_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_shipping_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_attribute_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_product_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//            'class' => 'submenu-disabled'
    ...
    private function tenant_digital_product_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//        ]);
    ...
    private function tenant_support_ticket_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('support-tickets-settings-menu-items', [
            'route' => '#',
            'label' => __('Support Tickets'),
    ...
    private function tenant_form_builder_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('form-builder-settings-menu-items', [
            'route' => '#',
            'label' => __('Form Builder'),
    ...
    private function tenant_mobile_app_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
    ...
    private function tenant_appearance_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('appearance-settings-menu-items', [
            'route' => '#',
            'label' => __('Appearance Settings'),
...
//        ]);
    ...
    private function tenant_general_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('general-settings-menu-items', [
            'route' => '#',
            'label' => __('General Settings'),
    ...
    private function tenant_users_manage_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('users-manage-settings-menu-items', [
            'route' => '#',
            'label' => __('Users Manage'),
    ...
    private function tenant_payment_settings_menus(TailwindMenuWithPermission $menu_instance): void
    {
        $menu_instance->add_menu_item('payment-settings-menu-items', [
            'route' => '#',
            'label' => __('Payment Settings'),
    ...
    private function tenant_admin_manage_menus(TailwindMenuWithPermission $menu_instance): void
    {
...
//        dd($current_tenant_payment_data);
    ...
    private function inject_plugin_registry_menus(\App\Helpers\TailwindMenuWithPermission $menu_instance, string $context): void
    {
        try {
            $menus = app(\App\PluginSystem\MenuRegistry::class)->getMenus($context);
            ...
            foreach ($menus as $menu) {
                ...
                $rawIcon = apply_filters('nazmart:plugin_menu_icon', $menu['icon'] ?? 'mdi mdi-puzzle', $menu['id']);
                // Normalize shorthand: 'mdi-xxx' → 'mdi mdi-xxx'
                if (str_starts_with($rawIcon, 'mdi-')) {
                    $rawIcon = 'mdi ' . $rawIcon;
                }
                ...
                $config = [
                    ...
                    'permissions' => isset($menu['permission']) ? [$menu['permission']] : [],
                    'icon'        => $rawIcon,
                ];

                $menu_instance->add_menu_item($menu['id'], $config);
                ...
                foreach ($menu['children'] ?? [] as $child) {
                    ...
                    $menu_instance->add_menu_item($child['id'], [
                        'route'       => $childRoute,
                        'label'       => __($child['label'] ?? ''),
                        'parent'      => $menu['id'],
                        'permissions' => isset($child['permission']) ? [$child['permission']] : [],
                    ]);
                }
            }
        } catch (\Throwable $e) {
            \Illuminate\Support\Facades\Log::channel('plugin')->warning(
                'MenuRegistry injection failed: ' . $e->getMessage()
            );
        }
    }
}
