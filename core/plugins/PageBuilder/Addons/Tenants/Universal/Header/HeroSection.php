...
namespace Plugins\PageBuilder\Addons\Tenants\Universal\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function admin_render(): string
    {
        ...
        $output .= Text::get(['name' => 'subtitle', 'label' => __('Sub-headline'), 'value' => $v['subtitle'] ?? null]);
        $output .= Text::get(['name' => 'button_text', 'label' => __('Button Text'), 'value' => $v['button_text'] ?? null]);
        $output .= Text::get(['name' => 'button_url', 'label' => __('Button URL'), 'value' => $v['button_url'] ?? null]);
        $output .= Image::get(['name' => 'hero_image', 'label' => __('Hero Image'), 'value' => $v['hero_image'] ?? null, 'dimensions' => '1200x600 px']);
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.universal.header.hero-section', $data);
    }
