...
@section('title') {{__('Create Mobile Intro')}} @endsection
...
<form action="{{ route('tenant.admin.mobile.intro.create') }}" method="post">
    @csrf
        ...
        <div class="lg:col-span-9">
            <div class="bg-surface rounded-xl shadow-main border border-main overflow-hidden">
                ...
                <div class="px-4 sm:px-6 py-4 border-b border-main flex items-center gap-3">
                    ...
                    <div>
                        <h3 class="text-sm font-bold text-dark font-urbanist">{{__('Add New Mobile Intro')}}</h3>
                        <p class="text-xs text-muted">{{__('Create a new intro slide for the mobile app')}}</p>
                    </div>
                    <div class="ml-auto">
                ...
                <div class="p-4 sm:p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2.5 bg-secondary border border-main rounded-xl px-4 py-2.5 focus-within:border-primary transition">
                            ...
                            <input type="text" name="title" placeholder="{{__('Mobile intro title...')}}"
                    ...
                    <div>
                        ...
                        <x-fields.tw-media-upload :title="__('Image')" :name="'image_id'" :dimentions="'1280x1280'"/>
                    </div>
