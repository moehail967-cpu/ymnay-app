...
namespace Plugins\PageBuilder\Addons\Tenants\Tinynest\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.tinynest.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Tinynest: Hero Section');
    }
