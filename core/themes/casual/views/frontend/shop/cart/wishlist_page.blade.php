        ...
        <div class="row g-4">
            <div class="col-lg-12">
                                    ...
                                    <td>
                                        <div class="cs-cart-product">
                                            ...
                                            <div class="cs-cart-product-info">
                                                <a href="{{ theme_product_url($slug) }}" class="cs-cart-product-name">
                                                    {{ $data->name }}
                                                </a>
                                                @if($data?->options?->color_name || $data?->options?->size_name || !empty($data?->options?->attributes))
                                                <div class="cs-cart-product-variants">
                                                    @if($data?->options?->color_name)
                                                        <span>{{ __('Color:') }} {{ $data->options->color_name }}</span>
                                                    @endif
                                                    @if($data?->options?->size_name)
                                                        <span>{{ __('Size:') }} {{ $data->options->size_name }}</span>
                                                    @endif
                ...
                <div class="cs-cart-bottom">
                    <a href="{{ theme_shop_url() }}" class="cs-cart-continue-btn">
