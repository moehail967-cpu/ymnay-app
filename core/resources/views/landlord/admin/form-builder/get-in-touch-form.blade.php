        ...
        <div class="bg-surface rounded-xl shadow-main border border-main overflow-hidden">
            <div class="px-4 sm:px-6 py-4 border-b border-main flex items-center gap-3">
                <div class="w-9 h-9 rounded-lg bg-primary-soft flex items-center justify-center flex-shrink-0">
                    <i class="las la-hand-paper text-primary text-base"></i>
                </div>
                <div>
                    <h3 class="text-sm font-bold text-dark font-urbanist">{{__('Get In Touch Form Builder')}}</h3>
            ...
            <div class="p-4 sm:p-6">
                <form action="{{route('admin.form.builder.get.in.touch')}}" method="POST">
                    @csrf
                    {!! render_tw_drag_drop_form_builder_markup(get_static_option('get_in_touch_form_fields')) !!}
        ...
        <div class="bg-surface rounded-xl shadow-main border border-main overflow-hidden sticky top-4">
            ...
            <div class="p-4">
                <ul id="sortable_02" class="fb-available-list" style="grid-template-columns: 1fr;">
                    ...
                    <li class="fb-available-item" type="date"><i class="las la-calendar"></i> {{__('Date')}}</li>
                </ul>
            </div>
        </div>
    </div>
