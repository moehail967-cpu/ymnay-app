...
class MegaMenuBuilderSetup  {
    ...
    {
        return apply_filters('nazmart:megamenu_items', []);
    }
    ...
    public function render_mega_menu_list($lang): string
    {
        ...
        $output .= ' <div id="megamenu-page-list-items-content" class="collapse" aria-labelledby="page-list-items"  data-bs-parent="#add_menu_item_accordion"> <div class="card-body">';
