...
<div class="el-dash-card">
    <div class="el-dash-card-title"><i class="las la-shopping-bag"></i> {{ __('My Orders') }}</div>
    ...
    <div class="table-responsive">
        <table class="el-dash-table">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ theme_user_order_detail_url($order->id) }}" class="el-btn el-btn-primary el-btn-sm">
