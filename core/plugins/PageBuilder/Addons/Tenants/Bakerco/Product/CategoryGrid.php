...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Our Baked Goods')),
        ...
        return self::renderView('tenant.bakerco.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('BakerCo: Category Grid');
    }
