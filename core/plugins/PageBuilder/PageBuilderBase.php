...
abstract class PageBuilderBase
{
    ...
    public function admin_form_submit_button($text = null): string
    {
        ...
        return '<button class="pb-save-btn widget_save_change_button">' . $button_text . '</button>';
    }
    ...
    public function admin_language_tab(): string
    {
        ...
        $output = '<div class="pb-lang-tabs"><nav><div class="nav nav-tabs" role="tablist">';
    ...
    public function admin_language_tab_start(){
        return '<div class="tab-content pb-lang-tabs">';
    }
    ...
    public function admin_form_before(){
        ...
        $markup .= '<h4 class="top-part"><span class="ui-icon ui-icon-arrowthick-2-n-s"></span>'.esc_html($this->addon_title()).'</h4>
