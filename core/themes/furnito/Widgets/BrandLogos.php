...
{
    protected function getWidgetType(): string { return 'furnito_brand_logos'; }
    protected function getWidgetName(): string { return 'Furnito: Brand Logos'; }
    ...
    protected function getWidgetTags(): array { return ['brands', 'logos', 'partners', 'furnito']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#fff;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Furnito: Brand Logos — preview on the live page</p></div>';
        }
        ...
        return view('theme-furnito::widgets.brand_logos', [
            'title'          => $content['title']     ?? '',
            'brands'         => $brands,
            'slides'         => $slides,
