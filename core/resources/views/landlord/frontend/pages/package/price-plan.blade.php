                                ...
                                <div class="btn-wrapper mt-4 mt-lg-5">
                                    @if($price_plan_item->has_trial == true)
                                        <div class="d-flex justify-content-center">
                                            <button type="button"
                                                    class="open-purchase-modal cmn-btn cmn-btn-outline-one color-one w-100 mx-1"
                                                    data-plan-id="{{$price_plan_item->id}}">
                                                {{__('Buy Now')}}
                                            </button>
                                            <button type="button"
                                                    class="open-purchase-modal cmn-btn cmn-btn-outline-one color-one w-100 mx-1"
                                    ...
                                    @else
                                        <button type="button"
                                                class="open-purchase-modal cmn-btn cmn-btn-outline-one color-one w-100"
                                                data-plan-id="{{$price_plan_item->id}}">
                                            {{__('Buy Now')}}
                                        </button>
                                    @endif
