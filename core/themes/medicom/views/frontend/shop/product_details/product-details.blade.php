...
@section('content')
    ...
    <!-- Product Detail Tabs -->
    <section class="mc-pd-tabs-section">
        <div class="container">
            <div class="mc-pd-tabs">
                <div class="mc-pd-tab-bar">
                    <button class="mc-pd-tab-btn active" data-tab="description">{{ __('Description') }}</button>
                    <button class="mc-pd-tab-btn" data-tab="reviews">{{ __('Reviews') }}</button>
                    <button class="mc-pd-tab-btn" data-tab="ship_return">{{ __('Ship & Return') }}</button>
                </div>
...
@section('scripts')
    <script>
        $(function () {
            ...
            /* ── Tabs ── */
            $(document).on('click', '.mc-pd-tab-btn', function () {
                let tab = $(this).data('tab');
                $('.mc-pd-tab-btn').removeClass('active');
                $(this).addClass('active');
                $('.mc-pd-tab-content').removeClass('active');
                $('#' + tab).addClass('active');
            });
            ...
            /* ── Thumbnail Click ── */
            $(document).on('click', '.mc-pd-thumb', function () {
                let image = $(this).data('image-path');
                let mainImg = $('.mc-pd-main-img img');
                mainImg.hide();
                mainImg.attr('src', image);
                mainImg.fadeIn(100);
                $('.mc-pd-thumb').removeClass('active');
                $(this).addClass('active');
            });
