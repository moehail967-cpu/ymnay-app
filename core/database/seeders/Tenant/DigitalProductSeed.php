...
class DigitalProductSeed extends Seeder
{
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_languages` (`id`, `name`, `slug`, `status`, `image_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_authors` (`id`, `name`, `slug`, `status`, `image_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_categories` (`id`, `name`, `slug`, `description`, `digital_product_type`, `image_id`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_sub_categories` (`id`, `category_id`, `name`, `slug`, `description`, `image_id`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_child_categories` (`id`, `category_id`, `sub_category_id`, `name`, `slug`, `description`, `image_id`, `status`, `created_at`, `updated_at`, `deleted_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_product_taxes` (`id`, `name`, `tax_percentage`, `status`, `created_at`, `updated_at`) VALUES
	    (1,'EU',10,1,'2023-04-15 19:19:04','2023-04-15 19:19:04')");
    }

    private function seedProduct()
    {
        DB::statement("INSERT IGNORE INTO `digital_products` (`id`, `name`, `slug`, `summary`, `description`, `product_type`, `image_id`, `status_id`, `included_files`, `version`, `release_date`, `update_date`, `preview_link`, `quantity`, `accessibility`, `is_licensable`, `tax`, `file`, `regular_price`, `sale_price`, `free_date`, `promotional_date`, `promotional_price`, `created_at`, `updated_at`, `deleted_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `additional_fields` (`id`, `product_id`, `badge_id`, `pages`, `language`, `formats`, `words`, `tool_used`, `database_used`, `compatible_browsers`, `compatible_os`, `high_resolution`, `author_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `additional_custom_fields` (`id`, `additional_field_id`, `option_name`, `option_value`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_product_categories` (`id`, `product_id`, `category_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_product_sub_categories` (`id`, `product_id`, `sub_category_id`, `created_at`, `updated_at`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_product_child_categories` (`id`, `product_id`, `child_category_id`, `created_at`, `updated_at`) VALUES
	    (3,23,1,NULL,NULL)");
    }

    private function seedProductTags()
    {
        DB::statement("INSERT IGNORE INTO `digital_product_tags` (`id`, `tag_name`, `product_id`, `type`) VALUES
        (20,'asd',1,'digital'),
        (21,'xcv',1,'digital'),
        (51,'asd',15,'digital'),
        (52,'xcv',15,'digital'),
    ...
    {
        DB::statement("INSERT IGNORE INTO `digital_product_refund_policies` (`id`, `product_id`, `refund_description`, `created_at`, `updated_at`) VALUES
