...
<div class="bg-surface rounded-xl shadow-main border border-main">
    ...
    <div class="px-4 sm:px-6 py-4 border-b border-main rounded-t-xl flex flex-wrap items-center justify-between gap-3">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h3 class="text-sm font-bold text-dark font-urbanist">{{__('Trashed Categories')}}</h3>
                <p class="text-xs text-muted">{{__('Restore or permanently delete categories')}}</p>
            </div>
        </div>
    ...
    <div class="tw-table-wrap">
        <table class="w-full text-left" id="trashCategoryTable">
            <thead>
...
@section('scripts')
    ...
    (function ($) {
        ...
        $(document).ready(function () {
            if ($.fn.DataTable && !$.fn.dataTable.isDataTable('#trashCategoryTable')) {
