                    ...
                    @foreach($products ?? [] as $product)
                        ...
                        <div class="el-card">
                            <div class="el-card-img-wrap">
                                ...
                                <!-- Wishlist -->
                                <button class="el-card-wish add-to-wishlist-btn" data-product_id="{{ $product->id }}" title="{{ __('Add to Wishlist') }}">
                            ...
                            <div class="el-card-body">
                                <a href="{{ to_product_details($product->slug) }}" class="el-card-name">
                                ...
                                <div class="el-card-footer">
                                    <div class="el-card-prices">
                                        <span class="el-card-price flash-prices">{{ amount_with_currency_symbol($final_price) }}</span>
                                    ...
                                    @if($product->inventory_detail_count < 1)
                                        <button class="el-card-atc add-to-cart-btn cart-loading"
                                                data-product_id="{{ $product->id }}"
                                                title="{{ __('Add to Cart') }}">
                                            <i class="las la-shopping-bag"></i>
                                        </button>
                                    @else
                                        <button class="el-card-atc product-quick-view-ajax cart-loading"
