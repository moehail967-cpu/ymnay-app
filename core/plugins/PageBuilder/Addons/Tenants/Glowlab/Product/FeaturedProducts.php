...
namespace Plugins\PageBuilder\Addons\Tenants\Glowlab\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Best Sellers')),
            'products'       => $products,
        ...
        return self::renderView('tenant.glowlab.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Glowlab: Featured Products');
    }
