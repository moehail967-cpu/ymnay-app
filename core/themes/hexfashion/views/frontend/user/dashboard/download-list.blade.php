...
<div class="hf-dash-card">
    <div class="hf-dash-card-title"><i class="las la-download"></i> {{ __('My Downloads') }}</div>
        ...
        <table class="hf-dash-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ $dl->download_url }}" class="hf-btn hf-btn-primary hf-btn-sm" target="_blank">
                        <i class="las la-download"></i> {{ __('Download') }}
                    </a>
                    @else
                    <span class="hf-badge hf-badge-muted">{{ __('Unavailable') }}</span>
                    @endif
                </td>
            </tr>
            @endforeach
