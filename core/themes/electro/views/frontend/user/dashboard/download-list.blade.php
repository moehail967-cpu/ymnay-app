...
<div class="el-dash-card">
    <div class="el-dash-card-title"><i class="las la-download"></i> {{ __('My Downloads') }}</div>
        ...
        <table class="el-dash-table">
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ $dl->download_url }}" class="el-btn el-btn-primary el-btn-sm" target="_blank">
                        <i class="las la-download"></i> {{ __('Download') }}
                    </a>
                    @else
                    <span class="el-badge el-badge-muted">{{ __('Unavailable') }}</span>
                    @endif
                </td>
            </tr>
            @endforeach
