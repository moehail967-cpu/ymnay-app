...
@section('content')
    ...
    <div class="el-page-banner">
        <div class="container">
            <h1 class="el-page-banner-title">{{ __('Checkout') }}</h1>
                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                                            ...
                                            <div class="el-form-group mb-3">
                                                ...
                                                <input type="text" name="username" class="el-form-input" placeholder="{{ __('Type your username') }}">
                                            </div>
                                            <div class="el-form-group mb-3">
                                            ...
                                            <div class="el-form-group mb-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <a href="{{theme_forget_password_url()}}" class="el-checkout-link">{{__('Forgot Password?')}}</a>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                        ...
                                        <p class="mt-3" style="font-size:13px;color:#666;">
                                            ...
                                            <a href="{{theme_register_url()}}" class="el-checkout-link">{{__('Sign up')}}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
