...
class MenuBuilderHelpers
{
    ...
    public function render_dynamic_pages_list($dynamic_page_list,$lang): string
    {
        ...
        foreach ($dynamic_page_list as $key => $page_details){
            ...
            $output .= '<div id="id_'.$random_number.'-page-list-items-content" class="collapse" aria-labelledby="id_'.$random_number.'page-list-items" data-bs-parent="#add_menu_item_accordion">';
