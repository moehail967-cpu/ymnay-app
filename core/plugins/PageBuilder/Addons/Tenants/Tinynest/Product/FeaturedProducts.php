...
namespace Plugins\PageBuilder\Addons\Tenants\Tinynest\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('New for Baby')),
            'products'       => $products,
        ...
        return self::renderView('tenant.tinynest.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Tinynest: Featured Products');
    }
