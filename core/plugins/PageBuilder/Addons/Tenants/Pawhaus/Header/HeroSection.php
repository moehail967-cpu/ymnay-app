...
namespace Plugins\PageBuilder\Addons\Tenants\Pawhaus\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.pawhaus.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Pawhaus: Hero Section');
    }
