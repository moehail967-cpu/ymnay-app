...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Shop by Room')),
        ...
        return self::renderView('tenant.maison.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('Maison: Category Grid');
    }
