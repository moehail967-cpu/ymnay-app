...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Collections')),
        ...
        return self::renderView('tenant.luxegems.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('Luxegems: Category Grid');
    }
