...
namespace Plugins\PageBuilder\Addons\Tenants\Bakerco\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.bakerco.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('BakerCo: Hero Section');
    }
