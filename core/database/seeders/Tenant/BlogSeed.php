...
class BlogSeed extends Seeder
{
    ...
    {
        DB::statement("INSERT IGNORE INTO `blog_categories` (`id`, `title`, `status`, `created_at`, `updated_at`, `slug`) VALUES
    ...
    {
        DB::statement("INSERT IGNORE INTO `blog_tags` (`id`, `title`, `slug`, `created_at`, `updated_at`) VALUES
