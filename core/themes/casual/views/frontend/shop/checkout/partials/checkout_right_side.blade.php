<div class="col-xl-4 col-lg-5 mt-4">
    <div class="checkout-order-summery border-1">
        ...
        @endif
            <div class="payment-inlines mt-4">
                ...
                <div class="payment-card mt-4">
                    ...
                    <div class="form-group d-none w-100 mt-3 manual_transaction_id">
                        ...
                        <input type="text" name="trasaction_id" class="cs-dash-input"
            ...
            <div class="mt-3">
                <a href="javascript:void(0)"
                   class="cs-checkout-btn checkout_disable proceed_checkout_btn">{{ __('Proceed to Checkout') }}</a>
            </div>

            <div class="mt-3">
                <a href="{{ theme_cart_url() }}" class="cs-checkout-btn-outline">{{ __('Return to Cart') }}</a>
            </div>
        </div>
    </div>
</div>
