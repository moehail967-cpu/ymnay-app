                ...
                <form action="{{ theme_register_store_url() }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="name" class="el-form-input" placeholder="{{ __('Your full name') }}" value="{{ old('name') }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="position:relative;">
                                <input type="password" name="password" id="el_reg_pwd" class="el-form-input" placeholder="{{ __('Create password') }}" style="padding-right:42px;">
                        ...
                        <div class="col-md-6">
                            ...
                            <div style="position:relative;">
                                <input type="password" name="password_confirmation" id="el_reg_pwd2" class="el-form-input" placeholder="{{ __('Confirm password') }}" style="padding-right:42px;">
                        ...
                        <div class="col-12">
                            <a class="el-generate-pwd" href="javascript:void(0)" style="font-size:13px;color:#E8603C;font-weight:600;display:inline-block;margin-bottom:4px;">
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $('.el-generate-pwd').on('click', function () {
