...
<div class="col-span-full">
    <h4 class="text-sm font-bold text-dark font-urbanist mb-4">{{__('Theme - '. $theme_name)}}</h4>
</div>
...
<x-colorpicker.input value="{{get_static_option('section_bg_1_'.$theme_slug,'#FFFBFB')}}" name="section_bg_1_{{$theme_slug}}" label="{{__('Section Background One')}}"/>
<x-colorpicker.input value="{{get_static_option('section_bg_2_'.$theme_slug,'#FFF6EE')}}" name="section_bg_2_{{$theme_slug}}" label="{{__('Section Background Two')}}"/>
<x-colorpicker.input value="{{get_static_option('section_bg_3_'.$theme_slug,'#F4F8FB')}}" name="section_bg_3_{{$theme_slug}}" label="{{__('Section Background Three')}}"/>
<x-colorpicker.input value="{{get_static_option('section_bg_4_'.$theme_slug,'#F2F3FB')}}" name="section_bg_4_{{$theme_slug}}" label="{{__('Section Background Four')}}"/>
<x-colorpicker.input value="{{get_static_option('section_bg_5_'.$theme_slug,'#F9F5F2')}}" name="section_bg_5_{{$theme_slug}}" label="{{__('Section Background Five')}}"/>
<x-colorpicker.input value="{{get_static_option('section_bg_6_'.$theme_slug,'#E5EFF8')}}" name="section_bg_6_{{$theme_slug}}" label="{{__('Section Background Six')}}"/>
