...
namespace Plugins\PageBuilder\Addons\Tenants\Trailco\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.trailco.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Trailco: Hero Section');
    }
