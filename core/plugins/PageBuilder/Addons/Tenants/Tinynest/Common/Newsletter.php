...
namespace Plugins\PageBuilder\Addons\Tenants\Tinynest\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.tinynest.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Tinynest: Newsletter');
    }
