        ...
        <div class="dashboard_posSystem__sidebar__estimate">
            ...
            <div class="dashboard_posSystem__sidebar__estimate__footer mt-4">
                <div class="dashboard_posSystem__sidebar__estimate__footer__btn btn_flex">
                    <a href="#1" class="orderBtn orderBtn_hold_order" data-bs-toggle="modal" data-bs-target="#proceedHold" v-if="customSubTotal > 0">
                    ...
                    <a href="#1" class="orderBtn orderBtn_proceed"
                       @click.prevent="document.querySelector('.payment-popup')?.classList.add('popup-active'); document.querySelector('.payment-popup-overlay')?.classList.add('popup-active')">
