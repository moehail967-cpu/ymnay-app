...
namespace Plugins\PageBuilder\Addons\Tenants\Velvetlux\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.velvetlux.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Velvetlux: Newsletter');
    }
