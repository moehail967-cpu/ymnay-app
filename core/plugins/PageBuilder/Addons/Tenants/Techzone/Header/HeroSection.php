...
namespace Plugins\PageBuilder\Addons\Tenants\Techzone\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.techzone.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Techzone: Hero Section');
    }
