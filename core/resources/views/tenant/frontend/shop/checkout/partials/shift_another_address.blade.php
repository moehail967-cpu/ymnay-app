            ...
            <div class="login-form checkout-form">
                <div class="checkout-form-flex">
                    ...
                    <div class="single-input mt-4">
                        ...
                        <input class="form--control" type="text" placeholder="{{ __('Type City/Town') }}" name="shift_city">
                    </div>
                </div>
                <div class="checkout-form-flex">
                    <div class="single-input mt-4">
                        <label class="label-title mb-3"> {{__('Name')}} </label>
                        <input class="form--control" type="tel" placeholder="{{ __('Type Full Name') }}" name="shift_name">
                    </div>
                    <div class="single-input mt-4">
                        <label class="label-title mb-3"> {{__('Mobile Number')}} </label>
                        <input class="form--control" type="tel" placeholder="{{ __('Type Mobile Number') }}" name="shift_phone">
                    </div>
                    <div class="single-input mt-4">
                        <label class="label-title mb-3"> {{__('Email Address')}} </label>
                        <input class="form--control" type="text" name="shift_email" placeholder="{{ __('Type Email') }}">
                    </div>
                </div>
                <div class="checkout-form-flex">
                    <div class="single-input mt-4">
