            ...
            t=setTimeout(function(){
                $.ajax({url:'{{ theme_search_ajax_url() }}',type:'GET',data:{search:q},success:function(d){
                    if(d.product_object&&d.product_object.length){
                        dd.innerHTML=d.markup+'<li class="el-search-footer"><a href="{{ theme_shop_url() }}?search='+encodeURIComponent(q)+'">{{ __("View all results") }} <i class="las la-arrow-right"></i></a></li>';
                    } else {
                        dd.innerHTML='<li class="el-search-empty"><i class="las la-search el-search-empty-icon"></i><span>{{ __("No results found") }}</span></li>';
                    }
