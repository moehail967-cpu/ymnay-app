...
<div class="general-info-wrapper">
    ...
    <div class="space-y-4">
        {{-- Base Cost --}}
        <div>
            <label class="block text-[10px] font-bold tracking-widest text-muted uppercase mb-1.5">{{ __("Base Cost") }} <x-fields.mandatory-indicator/></label>
            <div class="flex items-center gap-2.5 bg-surface border border-main rounded-xl px-3.5 py-2 focus-within:border-primary transition">
                ...
                <input type="text" class="flex-1 bg-transparent text-sm text-dark placeholder-subtle outline-none border-none focus:ring-0 p-0" value="{{ $product?->cost }}" name="cost" placeholder="{{ __("Base Cost...") }}">
            </div>
        ...
        <div>
            ...
            <div class="flex items-center gap-2.5 bg-surface border border-main rounded-xl px-3.5 py-2 focus-within:border-primary transition">
                ...
                <input type="text" class="flex-1 bg-transparent text-sm text-dark placeholder-subtle outline-none border-none focus:ring-0 p-0" value="{{ $product?->price }}" name="price" placeholder="{{ __("Enter Regular Price...") }}">
            </div>
        ...
        <div>
            ...
            <div class="flex items-center gap-2.5 bg-surface border border-main rounded-xl px-3.5 py-2 focus-within:border-primary transition">
                ...
                <input type="text" class="flex-1 bg-transparent text-sm text-dark placeholder-subtle outline-none border-none focus:ring-0 p-0" value="{{ $product?->sale_price }}" name="sale_price" placeholder="{{ __("Enter Sale Price...") }}">
            </div>
