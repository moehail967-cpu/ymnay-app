...
namespace Plugins\PageBuilder\Addons\Tenants\Bakerco\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Fresh From the Oven')),
            'products'       => $products,
        ...
        return self::renderView('tenant.bakerco.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('BakerCo: Featured Products');
    }
