            ...
            <div class="hf-auth-card">
                ...
                <form action="{{ route('tenant.user.login.otp') }}" method="post">
                    ...
                    <div style="margin-bottom:20px;">
                        <label class="hf-form-label">{{ __('Phone Number') }} <span class="hf-form-required">*</span></label>
                        <input type="tel" name="phone" id="telephone" class="hf-form-input" placeholder="{{ __('Your registered phone number') }}">
                    </div>
                    <button type="submit" id="login_btn" class="hf-btn hf-btn-primary hf-btn-block" style="padding:13px;font-size:15px;">
