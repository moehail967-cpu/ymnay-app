...
namespace Plugins\PageBuilder\Addons\Tenants\Pawhaus\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Pet Favorites')),
            'products'       => $products,
        ...
        return self::renderView('tenant.pawhaus.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Pawhaus: Featured Products');
    }
