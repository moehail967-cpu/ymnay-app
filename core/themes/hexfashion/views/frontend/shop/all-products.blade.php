...
<div class="hf-page-banner">
    <div class="container">
        <h1 class="hf-page-banner-title">{!! $page_post->title !!}</h1>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="hf-sidebar-card">
                <span class="hf-sidebar-title">{{ __('Search') }}</span>
                <div class="hf-search-bar">
                    <input type="text" id="hf-search-input" placeholder="{{ __('Search products…') }}">
            ...
            <div class="hf-sidebar-card">
                ...
                <div class="hf-size-list">
                    ...
                    <div class="hf-size-item">
                        <input type="checkbox" class="hf-size-checkbox" id="size_{{ $size->id }}" data-slug="{{ $size->id }}" data-label="{{ $size->size_code }}">
            ...
            <div class="hf-sidebar-card">
                ...
                <div class="hf-color-list">
                    ...
                    <div class="hf-color-item" title="{{ $color->name }}">
                        <input type="checkbox" class="hf-color-checkbox" id="color_{{ $color->id }}" data-slug="{{ $color->id }}">
...
$(function () {
    ...
    function elFilterRequest(page) {
        ...
        $.ajax({
            ...
            data: {
                ...
                page:      page,
                search:    $('#hf-search-input').val() || null,
                tag:       tag
            },
    ...
    $(document).on('keydown', '#hf-search-input', function (e) { if (e.key === 'Enter') elFilterRequest(); });

    $(document).on('click', '#hf-clear-filters', function () {
        $('.hf-cat-checkbox, .hf-size-checkbox, .hf-color-checkbox').prop('checked', false);
