...
namespace Plugins\PageBuilder\Addons\Tenants\Techzone\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.techzone.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Techzone: Newsletter');
    }
