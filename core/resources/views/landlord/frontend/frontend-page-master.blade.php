...
<section style="background: linear-gradient(to right, rgba(var(--main-color-one-rgb, 240, 72, 83), 0.05), rgba(var(--main-color-two-rgb, 255, 128, 93), 0.10));" class="mt-20 @if(request()->routeIs('landlord.homepage') || request()->routeIs('landlord.store.*') || (request()->routeIs('landlord.dynamic.page') && isset($page_post) && $page_post->breadcrumb == 0)) hidden @endif">
