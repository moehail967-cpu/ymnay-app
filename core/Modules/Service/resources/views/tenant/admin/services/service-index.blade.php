                ...
                <div class="modal-content">
                    ...
                    <form action="#" id="service_edit_modal_form" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            <x-fields.tw-media-upload name="image" dimentions="{{__('1920 X 1080 px image recommended')}}"/>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">{{__('Close')}}</button>
                            <button type="submit" class="btn btn-primary">{{__('Save Changes')}}</button>
    ...
    <script>
        $(document).ready(function($){
            ...
            $(document).on('click', '.service_edit_btn', function () {
                ...
                if (imageid != '') {
                    form.find('.tw-media-upload-wrapper .tw-img-wrap').html('<img src="' + image + '" class="w-full h-full object-cover rounded-lg">');
                    form.find('.tw-media-upload-wrapper .tw-img-wrap').removeClass('hidden');
                    form.find('.tw-media-upload-wrapper .tw-media-id-input').val(imageid);
                    form.find('.tw-media-upload-wrapper .tw-rmv-btn').removeClass('hidden');
                }
            });
