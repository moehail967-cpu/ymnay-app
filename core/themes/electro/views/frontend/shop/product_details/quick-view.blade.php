...
<div class="modal-dialog modal-xl">
    <div class="modal-content p-4 p-md-5">
        <div class="d-flex justify-content-end mb-3">
            <button class="quick-view-close-btn el-btn el-btn-ghost el-btn-sm">
                <i class="las la-times"></i>
            </button>
        </div>
        <div class="el-qv-layout">
            <!-- Image side -->
            <div class="el-qv-img-side">
                <div class="el-pd-main-img quick-view-long-img position-relative">
            ...
            <!-- Options side -->
            <div class="el-qv-options-side quick-view-shop-wrapper">
