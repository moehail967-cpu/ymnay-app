...
namespace Plugins\PageBuilder\Addons\Tenants\Maison\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __("Editor's Picks")),
            'products'       => $products,
        ...
        return self::renderView('tenant.maison.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Maison: Featured Products');
    }
