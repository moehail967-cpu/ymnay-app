...
@section('content')
    ...
    <!-- Product Detail Tabs -->
    <section class="hf-pd-tabs-section">
        <div class="container">
            <div class="hf-pd-tabs">
                <div class="hf-pd-tab-bar">
                    ...
                    <button class="hf-pd-tab-btn" data-tab="ship_return">{{ __('Ship & Return') }}</button>
                </div>
...
@section('scripts')
    <script>
        $(function () {
            ...
            /* ── Thumbnail Click ── */
            $(document).on('click', '.hf-pd-thumb', function () {
                let image = $(this).data('image-path');
                let mainImg = $('.hf-pd-main-img img');
                mainImg.hide();
                mainImg.attr('src', image);
                mainImg.fadeIn(100);
                $('.hf-pd-thumb').removeClass('active');
                $(this).addClass('active');
            });
