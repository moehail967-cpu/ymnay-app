                ...
                <div class="col-md-6" style="border-right:1px solid #f0e0d6;">
                    <div style="padding:40px 36px;">
                        ...
                        <form action="" method="post" id="login_form_order_page">
                            @csrf
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Email or Username') }}</label>
                                <input type="text" name="username" class="el-form-input" placeholder="{{ __('your@email.com') }}">
                            </div>
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Password') }}</label>
                                <div style="position:relative;">
                                    <input type="password" name="password" id="el_login_pwd" class="el-form-input" placeholder="••••••••" style="padding-right:42px;">
                            ...
                            <button type="submit" id="login_btn" class="el-btn el-btn-primary el-btn-block" style="font-size:15px;padding:13px;">
                                <i class="las la-sign-in-alt"></i> {{ __('Sign In') }}
                            </button>
                            @if(moduleExists('SmsGateway') && get_static_option('otp_login_status'))
                            <a href="{{ route('tenant.user.login.otp') }}" class="el-btn el-btn-outline el-btn-block mt-2" style="font-size:14px;padding:11px;">
                                {{ __('Login with OTP') }}
                            </a>
                            @endif
                        </form>
                    ...
                    <div style="padding:40px 36px;background:#fafafa;">
                        ...
                        <form action="{{ theme_register_store_url() }}" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="name" class="el-form-input" placeholder="{{ __('Jane Smith') }}" value="{{ old('name') }}">
                            </div>
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Username') }} <span class="el-form-required">*</span></label>
                                <input type="text" name="username" class="el-form-input" placeholder="{{ __('Choose a username') }}" value="{{ old('username') }}">
                            </div>
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Email Address') }} <span class="el-form-required">*</span></label>
                                <input type="email" name="email" class="el-form-input" placeholder="{{ __('your@email.com') }}">
                            </div>
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Password') }} <span class="el-form-required">*</span></label>
                                <input type="password" name="password" class="el-form-input" placeholder="{{ __('Min. 8 characters') }}">
                            </div>
                            <div class="mb-3">
                                <label class="el-form-label">{{ __('Confirm Password') }} <span class="el-form-required">*</span></label>
                                <input type="password" name="password_confirmation" class="el-form-input" placeholder="{{ __('Repeat your password') }}">
                            </div>
                            <button type="submit" id="register" class="el-btn el-btn-primary el-btn-block" style="font-size:15px;padding:13px;">
