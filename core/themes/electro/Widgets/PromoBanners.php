...
{
    protected function getWidgetType(): string { return 'electro_promo_banners'; }
    protected function getWidgetName(): string { return 'Electro: Promo Banners'; }
    ...
    protected function getWidgetTags(): array { return ['promo', 'banner', 'electro']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#fff5f0;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Electro: Promo Banners — preview on the live page</p></div>';
        }
        ...
        $fallbacks = [
            global_asset('core/' . theme_assets('images/promo_banner1.jpg', 'electro')),
            global_asset('core/' . theme_assets('images/promo_banner2.jpg', 'electro')),
        ];
        ...
        return view('theme-electro::widgets.promo_banners', [
            'cards'          => $cards,
