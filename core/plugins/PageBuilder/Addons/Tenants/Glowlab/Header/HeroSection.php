...
namespace Plugins\PageBuilder\Addons\Tenants\Glowlab\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.glowlab.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Glowlab: Hero Section');
    }
