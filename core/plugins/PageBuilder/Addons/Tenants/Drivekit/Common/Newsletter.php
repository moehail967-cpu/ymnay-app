...
namespace Plugins\PageBuilder\Addons\Tenants\Drivekit\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.drivekit.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Drivekit: Newsletter');
    }
