...
<div class="kv-cat-nav">
    <div class="container">
        <a href="javascript:void(0)" class="kv-cat-link active" data-slug="">{{ __('All') }}</a>
        @foreach($categories as $cat)
            <a href="javascript:void(0)" class="kv-cat-link" data-slug="{{ $cat->slug }}">
                {{ $cat->name }}
            </a>
        @endforeach
    </div>
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <label class="kv-filter-item">
                        <label class="d-flex align-items-center gap-2 mb-0" style="cursor:pointer;">
                            <input type="checkbox" class="kv-cat-checkbox" data-slug="{{ $cat->slug }}" data-value="{{ $cat->name }}" style="accent-color:var(--kv-red);">
                            {{ $cat->name }}
                        </label>
