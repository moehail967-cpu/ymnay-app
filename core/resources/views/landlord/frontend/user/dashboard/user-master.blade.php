                                    ...
                                    @if(!empty(get_static_option('user_wallet')))
                                        <li class="list has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li class="list {{request()->routeIs('landlord.user.wallet.withdraw') ? 'selected' : '' }}">
                                                    <a class="@if(request()->routeIs('landlord.user.wallet.withdraw')) active-submenu @endif"
                                                       href="{{route('landlord.user.wallet.withdraw')}}">{{__('Withdraw Histrory')}}</a>
                                                </li>
                                                <li class="list {{request()->routeIs('landlord.user.pay.commission') ? 'selected' : '' }}">
                                                    <a class="@if(request()->routeIs('landlord.user.pay.commission')) active-submenu @endif"
                                                       href="{{route('landlord.user.pay.commission')}}">{{__('Commission Payment')}}</a>
                                                </li>
                                            </ul>
                                        </li>
                                    @endif
