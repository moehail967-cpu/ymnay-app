...
namespace Plugins\PageBuilder\Addons\Tenants\Freshmart\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.freshmart.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Freshmart: Newsletter');
    }
