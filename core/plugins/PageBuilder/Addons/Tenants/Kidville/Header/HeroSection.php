...
namespace Plugins\PageBuilder\Addons\Tenants\Kidville\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.kidville.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Kidville: Hero Section');
    }
