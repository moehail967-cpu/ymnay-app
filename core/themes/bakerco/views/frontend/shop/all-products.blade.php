    ...
    <div class="row g-4">
        ...
        <div class="col-lg-3">
            ...
            <div class="bk-sidebar-card">
                ...
                <form class="bk-search" onsubmit="bkFilterRequest();return false;">
                    <input type="text" id="bk-search-input" placeholder="{{ __('Search products…') }}">
            ...
            <div class="bk-sidebar-card">
                ...
                <label class="bk-filter-item">
                    <label class="d-flex align-items-center gap-2 mb-0 bk-filter-cursor">
                        <input type="radio" name="bk_rating" class="bk-rating-filter" value="2">
                        <span><span class="bk-star-active">★★</span><span class="bk-star-empty">★★★</span></span>
                    </label>
                </label>
...
$(function () {
    ...
    function bkFilterRequest(page) {
        ...
        var search    = $('#bk-search-input').val() || null;
    ...
    // Search on Enter
    $(document).on('keydown', '#bk-search-input', function (e) {
        if (e.key === 'Enter') { bkFilterRequest(); }
    });
