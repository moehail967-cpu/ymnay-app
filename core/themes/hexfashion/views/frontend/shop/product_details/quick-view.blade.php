...
<div class="modal-dialog modal-xl">
    <div class="modal-content p-4 p-md-5">
        <div class="d-flex justify-content-end mb-3">
            <button class="quick-view-close-btn hf-btn hf-btn-ghost hf-btn-sm">
                <i class="las la-times"></i>
            </button>
        </div>
        <div class="hf-qv-layout">
            <!-- Image side -->
            <div class="hf-qv-img-side">
                <div class="hf-pd-main-img quick-view-long-img position-relative">
            ...
            <!-- Options side -->
            <div class="hf-qv-options-side quick-view-shop-wrapper">
