...
<div id="pdf_content_wrapper">
    <div class="cart-table-wrapper cart-wrapper">
        <div class="logo-wrapper" style="max-width: 150px;">
            <img src="{{ get_attachment_image_by_id(get_static_option('site_logo'), null, false)['img_url'] ?? '' }}"
    ...
    <div class="cart-total-table-wrap">
        <h2 class="title">{{__('Billing Summery')}}</h2>
