                   ...
                   <div class="order-tab-wrap">
                       ...
                       <div class="tab-content" >
                           ...
                           <div class="tab-pane fade show active" id="nav-home" role="tabpanel">
                               ...
                               @if(!auth()->guard('web')->check())
                                   <div class="login-form">
                                       <form action="{{theme_login_url()}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01" id="login_form_order_page">
                                           @csrf
                                           ...
                                           <div class="row mb-4 rmber-area">
                                               ...
                                               <div class="col-6 text-right">
                                                   <a class="d-block" href="{{theme_register_url()}}">{{__('Create new account?')}}</a>
                           ...
                           <div class="tab-pane fade @if(auth()->guard('web')->check()) show active @endif" id="nav-profile" role="tabpanel">
                            <form action="{{ theme_payment_form_url() }}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                                @csrf
                                @php
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group d-none manual_transaction_id">
                                            <input type="text" name="trasaction_id" class="form-control manual_transaction_id" placeholder="Transaction ID" >
                                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group"> <input type="email" id="email" name="email"  value="{{ auth()->guard('web')->user()->email }}" class="form-control" placeholder="Your Email" readonly></div>
                              ...
                              {!! \App\Helpers\FormBuilderCustom::render_form(get_static_option('order_form'),null,null,'btn-default') !!}
                                ...
                                <div class="form-group d-none manual_transaction_id">
                                    <input type="text" name="trasaction_id" class="form-control " placeholder="Transaction ID" >
                                </div>
                            </div>
                            <div class="col-lg-12">
                            <div class="form-group btn-wrapper">
