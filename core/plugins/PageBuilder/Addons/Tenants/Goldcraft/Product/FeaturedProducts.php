...
namespace Plugins\PageBuilder\Addons\Tenants\Goldcraft\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Signature Pieces')),
            'products'       => $products,
        ...
        return self::renderView('tenant.goldcraft.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Goldcraft: Featured Products');
    }
