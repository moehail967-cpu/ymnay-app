...
class TaxRenderService
{
    ...
    {
        $base = get_product_dynamic_price($this->product_object);
        $this->prices['regular_price'] = $base['regular_price'];
        $this->prices['sale_price']    = (double) $base['sale_price'];
        $this->prices['campaign_name'] = $base['campaign_name'];
        $this->prices['discount']      = $base['discount'];
        $this->prices['is_running']    = !empty($base['campaign_name']);
