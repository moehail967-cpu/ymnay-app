...
namespace Plugins\PageBuilder\Addons\Tenants\Sportzone\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.sportzone.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Sportzone: Newsletter');
    }
