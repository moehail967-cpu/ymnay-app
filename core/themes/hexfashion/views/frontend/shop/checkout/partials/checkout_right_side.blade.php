<div class="hf-checkout-summary">
    <h2 class="hf-dash-card-title"> {{__('Order Summary')}} </h2>
    <form action="#" class="hf-coupon-row coupon-contents-form mt-4">
        ...
        <input class="hf-form-input coupon-code" type="text" placeholder="{{__('Coupon Code')}}"
               name="used_coupon">
        <button type="button" class="hf-btn hf-btn-outline coupon-btn"> {{__('Apply')}}</button>
    </form>
    ...
    <div class="hf-checkout-items coupon-border mt-4 mb-4">
        ...
        @foreach($carts ?? [] as $data)
            ...
            <div class="hf-checkout-item">
                ...
                <span class="hf-checkout-item-price"> {{amount_with_currency_symbol($price * $data->qty)}} </span>
            </div>
            ...
            @if($user != null)
                <div class="hf-summary-row d-block">
                    ...
                    @foreach($shipping_methods ?? [] as $key => $method)
                        ...
                        <div class="hf-summary-row" data-country="{{isset($country) ? $country : 0}}"
