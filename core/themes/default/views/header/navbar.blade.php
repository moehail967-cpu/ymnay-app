                    ...
                    <div class="navbar-right-flex">
                        <div class="track-icon-list">
                            <div class="single-icon cart-shopping">
                                <a class="icon" href="{{ theme_compare_page_url() }}"> <i class="las la-sync"></i> </a>
                            </div>
                                ...
                                <div class="addto-cart-contents">
                                    ...
                                    @if($cart->count() != 0)
                                        ...
                                        <div class="btn-wrapper mt-3">
                                            <a href="{{theme_wishlist_url()}}" class="cart-btn cart-btn-outline radius-0 w-100"> {{__('View Wishlist')}} </a>
                                        </div>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="single-icon cart-shopping">
                                ...
                                <div class="addto-cart-contents">
                                    ...
                                    @if($cart->count() != 0)
                                        ...
                                        <div class="btn-wrapper mt-3">
                                            <a href="{{theme_checkout_url()}}" class="cart-btn radius-0 w-100"> {{__('Check Out')}} </a>
                                        </div>
                                        <div class="btn-wrapper mt-3">
                                            <a href="{{theme_cart_url()}}" class="cart-btn cart-btn-outline radius-0 w-100"> {{__('View Cart')}} </a>
                                        </div>
                                    @endif
                                </div>
                            </div>
                        ...
                        <div class="login-account">
                            ...
                            <ul class="account-list-item">
                                @auth('web')
                                    <li class="list"> <a href="{{theme_user_dashboard_url()}}"> {{__('Dashboard')}} </a> </li>
                                    <li class="list"> <a href="{{theme_logout_url()}}"> {{__('Log Out')}} </a> </li>
                                @else
                                    <li class="list"> <a href="{{theme_login_url()}}"> {{__('Sign In')}} </a> </li>
                                    <li class="list"> <a href="{{theme_register_url()}}"> {{__('Sign Up')}} </a> </li>
                                @endauth
                            </ul>
                        </div>
                    </div>
