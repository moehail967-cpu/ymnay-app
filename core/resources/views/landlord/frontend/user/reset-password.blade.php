                ...
                <div class="col-lg-6">
                    <div class="login-form-wrapper signin-contents">.
                        ...
                        <form action="{{route('tenant.user.reset.password.change')}}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                            ...
                            <div class="form-group single-input">
                                <input type="password" id="password" class="form-control form--control mt-3" name="password" placeholder="{{ __('Enter New Password') }}">
                            </div>
                            <div class="form-group single-input">
                                <input type="password" id="password_confirmation"  class="form-control form--control mt-3" name="password_confirmation" placeholder="{{ __('Confirm Password') }}">
                            </div>
