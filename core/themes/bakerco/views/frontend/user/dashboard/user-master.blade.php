...
<div class="bk-dash-section">
    <div class="container">

        <button class="bk-dash-mobile-toggle" id="bk-dash-toggle">
        ...
        <div class="bk-dash-wrap">
            ...
            {{-- Sidebar --}}
            <div class="bk-dash-sidebar" id="bk-dash-sidebar">
                @php $u = auth('web')->user(); @endphp
                <div class="bk-dash-user">
                    <div class="bk-dash-avatar">{{ strtoupper(substr($u?->name ?? 'U', 0, 1)) }}</div>
                    <div class="bk-dash-user-info">
                        <div class="bk-dash-name">{{ $u?->name }}</div>
                        <div class="bk-dash-email">{{ $u?->email }}</div>
                    </div>
                </div>
                <ul class="bk-dash-nav">
...
<x-media-upload.js/>
<script>
$('#bk-dash-toggle').on('click', function(){
    $('#bk-dash-sidebar').toggleClass('open');
});
</script>
