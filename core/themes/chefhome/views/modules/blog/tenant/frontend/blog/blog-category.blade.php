            ...
            <div class="ch-sidebar-card">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <label class="ch-filter-item" style="cursor:pointer;">
                        <a href="{{ $cat->url() }}" style="color:{{ isset($category_slug) && $category_slug === $cat->slug() ? 'var(--ch-red)' : 'inherit' }};text-decoration:none;font-weight:{{ isset($category_slug) && $category_slug === $cat->slug() ? '700' : '400' }}">
                            {{ $cat->name() }}
                        </a>
