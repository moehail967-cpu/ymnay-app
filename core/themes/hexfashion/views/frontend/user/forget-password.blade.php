            ...
            <div class="hf-auth-card">
                ...
                <form action="{{ route('tenant.user.forget.password') }}" method="post">
                    ...
                    <div style="margin-bottom:20px;">
                        <label class="hf-form-label">{{ __('Username or Email') }} <span class="hf-form-required">*</span></label>
                        <input type="text" name="username" class="hf-form-input" placeholder="{{ __('Enter your username or email') }}">
                    </div>
                    <button type="submit" id="forget_btn" class="hf-btn hf-btn-primary hf-btn-block" style="padding:13px;font-size:15px;">
                        {{ __('Send Reset Link') }}
                    </button>
                </form>
