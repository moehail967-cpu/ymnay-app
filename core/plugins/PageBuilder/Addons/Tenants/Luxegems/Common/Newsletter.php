...
namespace Plugins\PageBuilder\Addons\Tenants\Luxegems\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.luxegems.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Luxegems: Newsletter');
    }
