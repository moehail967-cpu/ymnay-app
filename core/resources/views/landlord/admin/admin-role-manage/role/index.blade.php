                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="table-wrap">
                            <table id="all_roles_table" class="table table-default table-striped table-bordered">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if($role->name != 'Super Admin')
                                                ...
                                                <a href="{{route(route_prefix().'admin.user.role.edit',$role->id)}}" class="btn btn-lg btn-primary btn-sm mb-3 mr-1">
...
@section('scripts')
    ...
    @else
        ...
        (function($){
            "use strict";
            $(document).ready(function() {
                $('#all_roles_table').DataTable({ "order": [[ 0, "desc" ]] });
            });
        })(jQuery);
        </script>
    @endif
