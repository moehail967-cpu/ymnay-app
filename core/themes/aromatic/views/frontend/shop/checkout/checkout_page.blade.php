                        ...
                        @else
                            <div class="col-xl-8 col-lg-7 mt-4">
                                <div class="sign-in">
                                    ...
                                    {!! theme_error_msg() !!}
                                    {!! theme_flash_msg() !!}
                                    <form action="" method="post" enctype="multipart/form-data" id="login_form_order_page">
                                        <div class="error-wrap mb-3"></div>
                                        <div class="mb-3">
                                            <label class="ar-auth-label" for="checkout_username">{{__('Username')}}<span class="ar-required">*</span></label>
                                            <input type="text" name="username" class="ar-auth-input" id="checkout_username" placeholder="{{ __('Type your username') }}">
                                        </div>
                                        <div class="mb-3">
                                            <label class="ar-auth-label" for="checkout_password">{{__('Password')}}<span class="ar-required">*</span></label>
                                            <input type="password" name="password" class="ar-auth-input" id="checkout_password" placeholder="{{ __('Password') }}">
                                        </div>
                                        <div class="mb-3 box-wrap">
                                            <div class="d-flex align-items-center gap-2">
                                                <input type="checkbox" name="remember" id="checkout_remember">
                                                <label for="checkout_remember" class="mb-0">{{__('Remember me')}}</label>
                                            </div>
                                            <a href="{{theme_forget_password_url()}}">{{__('Forgot Password?')}}</a>
                                        </div>
                                        <button type="submit" id="login_btn" class="btn-default">{{__('Sign In')}}</button>
                                    </form>
                                    <p class="info">{{__("Don't have an account?")}} <a href="{{theme_register_url()}}" class="active">{{__('Sign up')}}</a></p>
                                </div>
                            </div>
                        @endif
                    @else
