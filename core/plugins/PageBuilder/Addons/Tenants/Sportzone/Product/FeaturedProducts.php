...
namespace Plugins\PageBuilder\Addons\Tenants\Sportzone\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Top Gear')),
            'products'       => $products,
        ...
        return self::renderView('tenant.sportzone.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Sportzone: Featured Products');
    }
