...
namespace Plugins\PageBuilder\Addons\Tenants\Luxegems\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.luxegems.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Luxegems: Hero Section');
    }
