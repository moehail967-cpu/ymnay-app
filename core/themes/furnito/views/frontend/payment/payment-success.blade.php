...
{{--                                        <a href="{{theme_user_dashboard_url()}}" class="boxed-btn rounded-0 btn btn-primary">{{__('Go To Dashboard')}}</a>--}}
{{--                                    @else--}}
{{--                                        <a href="{{theme_home_url()}}" class="boxed-btn rounded-0 btn btn-primary">{{__('Back To Home')}}</a>--}}
{{--                                    @endif--}}
{{--                                </div>--}}
{{--                            </div>--}}
{{--                        </div>--}}
