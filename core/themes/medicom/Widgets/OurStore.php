...
{
    protected function getWidgetType(): string { return 'medicom_our_store'; }
    protected function getWidgetName(): string { return 'Medicom: Our Store'; }
    ...
    protected function getWidgetTags(): array { return ['store', 'filter', 'products', 'medicom']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Medicom: Our Store — preview on the live page</p></div>';
        }
        ...
        return view('theme-medicom::widgets.our_store', [
