...
class CategoryGrid extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Shop by Pet')),
        ...
        return self::renderView('tenant.pawhaus.product.category-grid', $data);
    }

    public function addon_title(): string
    {
        return __('Pawhaus: Category Grid');
    }
