...
namespace Plugins\PageBuilder\Addons\Tenants\Kidville\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __("Kids' Favorites")),
            'products'       => $products,
        ...
        return self::renderView('tenant.kidville.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Kidville: Featured Products');
    }
