<div id="reviews" class="hf-pd-tab-content">
    <div class="hf-pd-tab-inner">
        @if(Auth::guard('web')->check())
            <div class="hf-pd-reviews">
                {{-- Leave a Review Form --}}
                <div class="hf-pd-review-form">
                    ...
                    @foreach($product->reviews->take(5) ?? [] as $review)
                        <div class="hf-pd-review-item">
                            ...
                            <div class="hf-pd-reviewer-content">
                                ...
                                <span class="hf-pd-review-date">{{ $review->created_at?->diffForHumans() }}</span>
                            </div>
                        </div>
                    @endforeach
                </div>
                ...
                <div class="text-center mt-4">
                    <a href="javascript:void(0)" class="hf-btn hf-btn-outline see-more-review" data-items="5">
                        {{ __('See More') }}
                    </a>
                </div>
            </div>
        @else
            <div class="hf-pd-review-login">
                <div class="hf-auth-card" style="max-width:480px;margin:0 auto;">
