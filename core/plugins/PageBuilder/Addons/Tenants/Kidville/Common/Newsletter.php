...
namespace Plugins\PageBuilder\Addons\Tenants\Kidville\Common;
...
class Newsletter extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.kidville.common.newsletter', $data);
    }

    public function addon_title(): string
    {
        return __('Kidville: Newsletter');
    }
