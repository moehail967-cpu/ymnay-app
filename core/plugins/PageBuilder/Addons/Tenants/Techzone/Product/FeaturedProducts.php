...
namespace Plugins\PageBuilder\Addons\Tenants\Techzone\Product;
...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Featured Devices')),
            'products'       => $products,
        ...
        return self::renderView('tenant.techzone.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Techzone: Featured Products');
    }
