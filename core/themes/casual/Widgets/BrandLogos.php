...
{
    protected function getWidgetType(): string { return 'casual_brand_logos'; }
    protected function getWidgetName(): string { return 'Casual: Brand Logos'; }
    ...
    protected function getWidgetTags(): array { return ['brand', 'logos', 'partners', 'casual']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Casual: Brand Logos — preview on the live page</p></div>';
        }
        ...
        return view('theme-casual::widgets.brand_logos', [
