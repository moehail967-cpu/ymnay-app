...
namespace Plugins\PageBuilder\Addons\Tenants\Velvetlux\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.velvetlux.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Velvetlux: Hero Section');
    }
