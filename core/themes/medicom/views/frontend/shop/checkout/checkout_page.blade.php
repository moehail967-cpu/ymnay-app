...
@section('content')
    ...
    <div class="mc-page-banner">
        <div class="container">
            <h1 class="mc-page-banner-title">{{ __('Checkout') }}</h1>
            ...
            <div class="container">
                ...
                <div class="mc-checkout-layout">
                    @if(!empty(get_static_option('guest_order_system_status')))
                        ...
                        @else
                            <div class="mc-checkout-left">
                                <div class="mc-checkout-login">
                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                                            ...
                                            <div class="mc-form-group mb-3">
                                                <label class="mc-form-label">{{__('Username')}}<span class="mc-form-required">*</span></label>
                                                <input type="text" name="username" class="mc-form-input" placeholder="{{ __('Type your username') }}">
                                            </div>
                                            <div class="mc-form-group mb-3">
                                            ...
                                            <div class="mc-form-group mb-3">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <a href="{{theme_forget_password_url()}}" class="mc-checkout-link">{{__('Forgot Password?')}}</a>
                                                </div>
                                            </div>
                                            <div class="mt-3">
                                                <button type="submit" id="login_btn" class="mc-btn mc-btn-primary">{{__('Sign In')}}</button>
                                            </div>
                                        </form>
                                        <p class="mt-3" style="font-size:13px;color:#666;">
                                            {{__("Don't have an account?")}}
                                            <a href="{{theme_register_url()}}" class="mc-checkout-link">{{__('Sign up')}}</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
