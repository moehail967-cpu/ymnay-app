        ...
        <div class="table-responsive table-responsive--md">
            <form action="{{route('landlord.user.wallet.settings')}}" method="POST">
                ...
                <div class="form-group minimum_alert_amount_wrapper">
                    ...
                    <input type="text" class="form-control form--control" id="minimum_alert_amount" name="minimum_alert_amount" placeholder="{{ __('Example 100') }}" value="{{!empty($settings) ? $settings->minimum_amount : ''}}"/>
                </div>
