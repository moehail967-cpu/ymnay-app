...
Agent definitions specify only: identity/handle, Role, Responsibilities, Allowed actions, Forbidden actions, Required knowledge, Inputs, Outputs, Handoff rules, and Quality gates.
