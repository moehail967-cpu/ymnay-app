                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                                            ...
                                            <div class="hf-form-group mb-3">
                                                <label class="hf-form-label">{{__('Username')}}<span class="required">*</span></label>
                                                <input type="text" name="username" class="hf-form-input" id="exampleInputEmail1" placeholder="Type your username">
                                            </div>
                                            <div class="hf-form-group mb-3">
                                                <label class="hf-form-label">{{__('Password')}}<span class="required">*</span></label>
                                                <input type="password" name="password" class="hf-form-input" id="exampleInputPassword1" placeholder="Password">
                                            </div>
                                            <div class="hf-form-group mb-3">
                                        ...
                                        <p class="mt-3" style="font-size:14px;">{{__("Don'/t have an account")}} <a href="{{theme_register_url()}}" class="hf-checkout-link">{{__('Sign up')}}</a></p>
                                    </div>
                                </div>
                            </div>
                        @endif
