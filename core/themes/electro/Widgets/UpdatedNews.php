...
class UpdatedNews extends BaseWidget
{
    protected function getWidgetType(): string { return 'electro_updated_news'; }
    protected function getWidgetName(): string { return 'Electro: Updated News'; }
    ...
    protected function getWidgetTags(): array { return ['blog', 'news', 'electro']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Electro: Updated News — preview on the live page</p></div>';
        }
        ...
        return view('theme-electro::widgets.updated_news', [
