...
// New Footer Widgets (landlord)
use Plugins\WidgetBuilder\Widgets\landlord\Footer\FooterLogoWidget;
use Plugins\WidgetBuilder\Widgets\landlord\Footer\FooterNavLinksWidget;
use Plugins\WidgetBuilder\Widgets\landlord\Footer\FooterSocialWidget;
use Plugins\WidgetBuilder\Widgets\landlord\Footer\FooterNewsletterWidget;
use Plugins\WidgetBuilder\Widgets\landlord\Footer\FooterCopyrightLinksWidget;

// Global Tenant Footer Widgets (all themes)
use Plugins\WidgetBuilder\Widgets\Tenant\Footer\GlobalFooterBrandWidget;
use Plugins\WidgetBuilder\Widgets\Tenant\Footer\GlobalFooterNavWidget;
use Plugins\WidgetBuilder\Widgets\Tenant\Footer\GlobalFooterBadgesWidget;
...
class WidgetBuilderSetup
{
    private static function registerd_widgets(){
        // Built-in Widget
        $widget = [
            // Old landlord footer widgets (commented out — replaced by new footer widgets)
            // AboutUsWidget::class,
            ...
            // New Footer Widgets (landlord)
            FooterLogoWidget::class,
            FooterNavLinksWidget::class,
            FooterSocialWidget::class,
            FooterNewsletterWidget::class,
            FooterCopyrightLinksWidget::class,

            // Global Tenant Footer Widgets (all themes)
            GlobalFooterBrandWidget::class,
            GlobalFooterNavWidget::class,
            GlobalFooterBadgesWidget::class,
        ];

        // Third party custom addons
        $customAddons = apply_filters('nazmart:widgetbuilder_addons', []);
    ...
    {
        $register_widgets_for_admin = ['footer','footer_bottom','footer_copyright','sidebar'];
    ...
    public static function render_admin_sidebar_item($sidebar){
        $markup = '<div class="card">
                    <div class="card-header widget-area-header">
                        ...
                        <span class="widget-area-expand"><i class="mdi mdi-chevron-down text-sm"></i></span>
                    </div>
