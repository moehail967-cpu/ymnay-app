                    ...
                    <form action="{{theme_checkout_url()}}" method="POST" class="checkout-form" enctype="multipart/form-data">
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Full Name')}}<x-fields.mandatory-indicator/> </label>
                                <input class="form--control" type="text" name="name" placeholder="{{__('Type Full Name')}}" value="@auth('web'){{$billing_info ? $billing_info->full_name:auth('web')->user()?->name}}@else{{old('name')}}@endauth" {{$readonly}}>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
