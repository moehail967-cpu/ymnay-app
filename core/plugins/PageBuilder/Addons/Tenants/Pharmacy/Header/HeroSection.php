...
namespace Plugins\PageBuilder\Addons\Tenants\Pharmacy\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.pharmacy.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Pharmacy: Hero Section');
    }
