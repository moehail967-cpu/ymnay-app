...
-------------------------------------------- */
    ...
    Route::controller(\App\Http\Controllers\Tenant\Admin\MyPackageOrderController::class)->prefix('package')->group(function () {
        ...
        Route::get('/checkout/{plan_id}', 'plan_checkout')->name('my.package.checkout');
        Route::post('/checkout/initiate', 'initiate_checkout')->name('my.package.checkout.initiate');
        Route::get('/payment/success', 'payment_success')->name('my.package.payment.success');
    });
...
//dd($path);
    ...
    ------------------------------------------------------------------ */
    Route::controller(\App\Http\Controllers\Tenant\Admin\PluginController::class)
        ->prefix('plugins')
        ->name('admin.plugins.')
        ->group(function () {
    ...
    Route::controller(\App\Http\Controllers\Tenant\Admin\PluginSettingsController::class)
