...
<div class="hf-dash-card">
    <div class="hf-dash-card-title"><i class="las la-shopping-bag"></i> {{ __('My Orders') }}</div>
    ...
    <div class="table-responsive">
        <table class="hf-dash-table">
            ...
            <tr>
                ...
                <td>
                    <a href="{{ theme_user_order_detail_url($order->id) }}" class="hf-btn hf-btn-primary hf-btn-sm">
