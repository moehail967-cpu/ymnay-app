            ...
            <div class="el-auth-card">
                <div style="text-align:center;margin-bottom:28px;">
                    ...
                    <p style="font-size:13px;color:#888;">
                        ...
                        <strong id="el-otp-timer" style="color:#E8603C;">05:00</strong>.
                    </p>
                </div>
                ...
                <form action="{{ theme_otp_verify_url() }}" method="post">
                    ...
                    <div style="margin-bottom:20px;">
                        <label class="el-form-label">{{ __('OTP Code') }} <span class="el-form-required">*</span></label>
                        <input type="text" name="otp" class="el-form-input" placeholder="{{ __('Enter 6-digit code') }}"
                               maxlength="6" inputmode="numeric" autocomplete="one-time-code"
                               style="font-size:22px;font-weight:800;text-align:center;letter-spacing:.3em;">
                    </div>
                    <button type="submit" id="otp_verify_btn" class="el-btn el-btn-primary el-btn-block" style="padding:13px;font-size:15px;">
                        <i class="las la-check-circle"></i> {{ __('Verify & Sign In') }}
                    </button>
                </form>

                <div style="text-align:center;margin-top:16px;">
                    <button id="el-otp-resend" class="el-btn el-btn-ghost el-btn-sm" disabled>
...
(function($){
    ...
    var timer = setInterval(function(){
        ...
        $('#el-otp-timer').text((m < 10 ? '0' : '') + m + ':' + (s < 10 ? '0' : '') + s);
        if(seconds <= 0){ clearInterval(timer); $('#el-otp-resend').prop('disabled', false); }
    }, 1000);

    $('#el-otp-resend').on('click', function(){
        var btn = $(this);
