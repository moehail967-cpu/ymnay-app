...
<div class="container" style="padding:40px 0 80px;">
    <div class="row g-4">
        ...
        {{-- Sidebar --}}
        <div class="col-lg-3">
            <div class="hf-dash-sidebar">
                <div class="hf-dash-user-info">
                    <div class="hf-dash-avatar">{{ strtoupper(substr(auth('web')->user()?->name ?? 'U', 0, 1)) }}</div>
                    <div class="hf-dash-name">{{ auth('web')->user()?->name }}</div>
                    <div class="hf-dash-email">{{ auth('web')->user()?->email }}</div>
                </div>
                <ul class="hf-dash-nav">
