<!DOCTYPE html>
<html lang="{{ \App\Facades\GlobalLanguage::user_lang_slug() }}" dir="{{ function_exists('get_lang_direction') ? get_lang_direction() : 'ltr' }}">
    <head>
        ...
        <style type="text/css" media="screen">
            ...
            * {
            ...
            .pl-0 { padding-left: 0.75rem !important; padding-right: 0 !important; }
            .pr-0 { padding-right: 0.75rem !important; padding-left: 0 !important; }
            @endif
            .party-header {
                font-size: 1.5rem;
                font-weight: 400;
