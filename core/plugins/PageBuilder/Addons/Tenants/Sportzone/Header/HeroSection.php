...
namespace Plugins\PageBuilder\Addons\Tenants\Sportzone\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.sportzone.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Sportzone: Hero Section');
    }
