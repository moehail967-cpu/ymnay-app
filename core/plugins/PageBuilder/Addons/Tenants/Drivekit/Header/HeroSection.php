...
namespace Plugins\PageBuilder\Addons\Tenants\Drivekit\Header;
...
class HeroSection extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        return self::renderView('tenant.drivekit.header.hero-section', $data);
    }

    public function addon_title(): string
    {
        return __('Drivekit: Hero Section');
    }
