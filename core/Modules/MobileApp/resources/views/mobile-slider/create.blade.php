...
@section('title') {{__('Create Mobile Slider')}} @endsection
            ...
            <div class="bg-surface rounded-xl shadow-main border border-main overflow-hidden">
                ...
                <div class="px-4 sm:px-6 py-4 border-b border-main flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-muted">{{__('Create a new slider for the mobile app')}}</p>
                    </div>
                    <div class="ml-auto">
                ...
                <div class="p-4 sm:p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2.5 bg-secondary border border-main rounded-xl px-4 py-2.5 focus-within:border-primary transition">
                            ...
                            <input type="text" name="title" value="{{old('title')}}" placeholder="{{__('Slider title...')}}"
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5" placeholder="{{__('Slider description...')}}"
                                  class="w-full bg-secondary border border-main rounded-xl px-4 py-2.5 text-sm text-dark placeholder-subtle outline-none focus:border-primary transition resize-none">{{old('description')}}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2.5 bg-secondary border border-main rounded-xl px-4 py-2.5 focus-within:border-primary transition">
                            ...
                            <input type="text" name="button_text" value="{{old('button_text')}}" placeholder="{{__('Button text...')}}"
                                   class="flex-1 bg-transparent text-sm text-dark placeholder-subtle outline-none border-none focus:ring-0 p-0">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2.5 bg-secondary border border-main rounded-xl px-4 py-2.5 focus-within:border-primary transition">
                            ...
                            <input type="text" name="button_url" value="{{old('button_url')}}" placeholder="{{__('Button URL...')}}"
                                   class="flex-1 bg-transparent text-sm text-dark placeholder-subtle outline-none border-none focus:ring-0 p-0">
                        </div>
                    </div>
