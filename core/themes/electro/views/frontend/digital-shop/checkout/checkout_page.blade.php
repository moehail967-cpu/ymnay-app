...
@section('style')
    <style>
        ...
        .el-checkout-layout { display: flex; gap: 28px; align-items: flex-start; }
    </style>
@endsection

@section('content')
    @if(Cart::count() > 0)
        <div class="el-checkout-section">
            <div class="container">
                {!! theme_error_msg() !!}
                <div class="el-checkout-layout">
                    @if(!empty(get_static_option('guest_order_system_status')))
                        ...
                        @else
                            <div class="el-checkout-left">
                                <div class="el-checkout-login">
                                    ...
                                    <div class="form-wrapper">
                                        ...
                                        <form action="" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                                            ...
                                            <div class="el-form-group mb-3">
                                                <label class="el-form-label">{{__('Username')}}<span class="required">*</span></label>
                                                <input type="text" name="username" class="el-form-input" id="exampleInputEmail1" placeholder="Type your username">
                                            </div>
                                            <div class="el-form-group mb-3">
                                                <label class="el-form-label">{{__('Password')}}<span class="required">*</span></label>
                                                <input type="password" name="password" class="el-form-input" id="exampleInputPassword1" placeholder="Password">
                                            </div>
                                            <div class="el-form-group mb-3">
                                            ...
                                            <div class="mt-3">
                                                <button type="submit" id="login_btn" class="el-btn el-btn-primary">{{__('Sign In')}}</button>
                                            </div>
                                        </form>
                                        <p class="mt-3" style="font-size:14px;">{{__("Don'/t have an account")}} <a href="{{theme_register_url()}}" class="el-checkout-link">{{__('Sign up')}}</a></p>
                                    </div>
                                </div>
                            </div>
                        @endif
