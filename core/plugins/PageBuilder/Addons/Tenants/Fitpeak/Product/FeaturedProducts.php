...
class FeaturedProducts extends PageBuilderBase
{
    ...
    public function frontend_render(): string
    {
        ...
        $data = [
            'title'          => SanitizeInput::esc_html($this->setting_item('title') ?? __('Top Performers')),
            'products'       => $products,
        ...
        return self::renderView('tenant.fitpeak.product.featured-products', $data);
    }

    public function addon_title(): string
    {
        return __('Fitpeak: Featured Products');
    }
