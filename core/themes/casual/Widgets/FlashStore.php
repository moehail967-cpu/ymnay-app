...
{
    protected function getWidgetType(): string { return 'casual_flash_store'; }
    protected function getWidgetName(): string { return 'Casual: Flash Store'; }
    ...
    protected function getWidgetTags(): array { return ['flash', 'store', 'slider', 'casual']; }
    ...
    public function render(array $settings = []): string
    {
        if (!function_exists('tenant') || !tenant()) {
            return '<div style="padding:40px;text-align:center;background:#f9f9f9;border:1px dashed #ccc;border-radius:8px;color:#888;font-family:sans-serif;"><p style="margin:0;font-size:14px;">Casual: Flash Store — preview on the live page</p></div>';
        }
        ...
        return view('theme-casual::widgets.flash_store', [
