...
.cross-icon:hover { color: var(--delete-color); }
</style>
...
<template>
                                        ...
                                        <div class="col-xxl-8 col-lg-7">
                                            <div class="dashboard_posSystem__left">
                                                ...
                                                <div class="load-more-products text-center mt-5 mb-3" v-if="Products.pagination.current_page !== Products.pagination.last_page">
                                                    <button class="load-more-btn" @click.prevent="loadMore"><i class="las la-sync-alt"></i> Load More</button>
                                                </div>
                                            </div>
                                        </div>
    ...
    <AddCustomer/>
    <ProceedToCart @cartAdded="testCallback" :customer="customer"
...
export default {
    ...
    setup: (props, {emit}) => {
        ...
        const getInvoiceData = (data) => {
            ...
            document.querySelector('.invoice-popup')?.classList.add('popup-active');
            document.querySelector('.invoice-popup-overlay')?.classList.add('popup-active');
        }
